#### Test 558877588826def_thali03_LGE-LG-D855 Logs


```
--------- beginning of main
D/sensors_hal_Time( 1039): tsOffsetIs: Apps: 277462097862; DSPS: 9232644; Offset : -4313890899
,D/AndroidRuntime( 7103): 
D/AndroidRuntime( 7103): >>>>>> AndroidRuntime START com.android.internal.os.RuntimeInit <<<<<<
D/AndroidRuntime( 7103): CheckJNI is OFF
D/AndroidRuntime( 7103): Calling main entry com.android.commands.am.Am
--------- beginning of system
...
D/ActivityManager( 1039): setTaskToReturnTo : TaskRecord{15c44918 #4 A=com.test.thalitest U=0 sz=0} / mTaskToReturnTo = 1
D/ActivityManager( 1039): setTaskToReturnTo : TaskRecord{15c44918 #4 A=com.test.thalitest U=0 sz=0} / mTaskToReturnTo = 1
D/WindowStateEx( 1039): AppWindowTokenEx init.. 
E/GBMv2   (  331): DFP En is all cleared set to be enabled
I/ActivityManager( 1039): Start proc com.test.thalitest for activity com.test.thalitest/.MainActivity: pid=7118 uid=10311 gids={50311, 9997, 3003, 3001, 3002, 1028, 1015} abi=armeabi-v7a
D/AndroidRuntime( 7103): Shutting down VM
...
D/SplitWindowPolicy( 1958): topRunningActivity=ActivityInfo{123e3e2b co.....MainActivity}, taskId=4, activityType=0, bIsSplit=false
D/SplitWindowPolicy( 1958): updateActivityStateChanged: resumed=false, screenId=1, isScreenFull=true
D/SplitWindowPolicy( 1958): topRunningActivity=ActivityInfo{3bb3c288 co.....MainActivity}, taskId=4, activityType=0, bIsSplit=false
...
,I/LibraryLoader( 7118): Time to load native libraries: 3 ms (timestamps 8401-8404)
I/LibraryLoader( 7118): Expected native library version number "",actual native library version number ""
V/WebViewChromiumFactoryProvider( 7118): Binding Chromium to main looper Looper (main, tid 1) {2ccec89b}
I/LibraryLoader( 7118): Expected native library version number "",actual native library version number ""
...
V/AudioPolicyService(  316): registerClient() client 0xb57bba80, uid 10311
,D/BluetoothManagerService( 1039): Message: 20
D/BluetoothManagerService( 1039): Added callback: android.bluetooth.IBluetoothManagerCallback$Stub$Proxy@3b815ce2:true
...
,D/SplitWindow( 1039): check instance of lgWin Window{1301fa8c u0 com.test.thalitest/com.test.thalitest.MainActivity}
...
I/SystemUI[Framework]( 1039): ==>disabledNaviBtn() what=0x0, token=android.os.Binder@26d0184c,  pkg=WindowManager.LayoutParams
...
I/ActivityManager( 1039): Displayed com.test.thalitest/.MainActivity: +612ms (total +712ms)
I/Timeline( 7118): Timeline: Activity_idle id: android.os.BinderProxy@32af0e8b time:278824
I/Timeline( 1039): Timeline: Activity_windows_visible id: ActivityRecord{33689f71 u0 com.test.thalitest/.MainActivity t4} time:278827
D/JsMessageQueue( 7118): Set native->JS mode to OnlineEventsBridgeMode
D/jxcore_app_log( 7118): JniHelper::setJavaVM(0xb487c280), pthread_self() = -1435086592
...
,W/.test.thalitest( 7118): type=1400 audit(0.0:162): avc: denied { ioctl } for path="socket:[8634]" dev="sockfs" ino=8634 scontext=u:r:untrusted_app:s0 tcontext=u:r:zygote:s0 tclass=unix_dgram_socket,
W/.test.thalitest( 7118): type=1400 audit(0.0:163): avc: denied { ioctl } for path="/sys/kernel/debug/tracing/trace_marker" dev="debugfs" ino=3222 scontext=u:r:untrusted_app:s0 tcontext=u:object_r:debugfs:s0 tclass=file
W/.test.thalitest( 7118): type=1400 audit(0.0:164): avc: denied { ioctl } for path="socket:[8754]" dev="sockfs" ino=8754 scontext=u:r:untrusted_app:s0 tcontext=u:r:zygote:s0 tclass=unix_dgram_socket
W/.test.thalitest( 7118): type=1400 audit(0.0:165): avc: denied { ioctl } for path="/cust" dev="mmcblk0p42" ino=2 scontext=u:r:untrusted_app:s0 tcontext=u:object_r:cust_data_file:s0 tclass=dir
W/.test.thalitest( 7118): type=1400 audit(0.0:166): avc: denied { ioctl } for path="socket:[35099]" dev="sockfs" ino=35099 scontext=u:r:untrusted_app:s0 tcontext=u:r:surfaceflinger:s0 tclass=unix_stream_socket
,I/art     ( 7118): Background sticky concurrent mark sweep GC freed 124589(12MB) AllocSpace objects, 23(7MB) LOS objects, 28% free, 39MB/55MB, paused 1.674ms total 137.021ms
...
D/WifiServiceImplEx( 1039): setWifiEnabled: true pid=7118, uid=10311, package= com.test.thalitest, App Lable : ThaliTest
D/WifiService( 1039): setWifiEnabled: true pid=7118, uid=10311
E/WifiService( 1039): Invoking mWifiStateMachine.setWifiEnabled
D/WifiServiceImplEx( 1039): disconnect pid=7118, uid=10311, packageName=com.test.thalitest
,E/WifiStateMachine( 1039):  ConnectedState CMD_DISCONNECT 0 0
E/WifiStateMachine( 1039):  L2ConnectedState CMD_DISCONNECT 0 0
E/WifiNative: ( 1039): [281,230,334 us] DISCONNECT  stack:logDbg - disconnect - processMessage - processMsg - handleMessage
D/WifiNative-wlan0( 1039): doBoolean: DISCONNECT
D/WifiServiceImplEx( 1039): reconnect pid=7118, uid=10311, packageName=com.test.thalitest
...
D/LGWifiP2pService( 1039): P2pEnabledState{ when=-17ms what=143375 target=com.android.internal.util.StateMachine$SmHandler }
D/DhcpStateMachine( 1039): RunningState{ when=-7ms what=196610 target=com.android.internal.util.StateMachine$SmHandler }
V/NativeCrypto( 2117): Read error: ssl=0xaa6d2000: I/O error during system call, Connection timed out
D/Tethering( 1039): sendTetherStateChangedBroadcast 0, 0, 0
V/NativeCrypto( 2117): SSL shutdown failed: ssl=0xaa6d2000: I/O error during system call, Broken pipe
...
I/ActivityManager( 1039): Start proc com.android.settings for broadcast com.android.settings/.deviceinfo.UsbSettingsReceiver: pid=7213 uid=1000 gids={41000, 9997, 1000, 1028, 1015, 2001, 3002, 3001, 1007, 3003, 1023, 1021, 3004, 3005, 3009, 1010, 1004, 2002, 3008, 1026, 1009, 1027, 1003, 1014, 4002, 1002} abi=armeabi-v7a
...
E/WifiNative: ( 1039): [281,386,788 us] RECONNECT  stack:logDbg - reconnect - processMessage - processMsg - handleMessage
...
E/WifiStateMachine( 1039):  DisconnectingState NETWORK_DISCONNECTION_EVENT c0:ff:d4:d3:aa:48 nid=1 reason=3 rt=281393
E/WifiStateMachine( 1039):  ConnectModeState NETWORK_DISCONNECTION_EVENT c0:ff:d4:d3:aa:48 nid=1 reason=3 rt=281393
D/WifiNative-wlan0( 1039): doBoolean: DRIVER BTCOEXMODE 2
...
I/StatusBar.NetworkController( 1465): mWifiConnected = false, mWifiLevel = 0
D/WifiHS20( 1039): hidePasspointNotification off =false
E/WifiStateMachine( 1039):  DisconnectedState SUPPLICANT_STATE_CHANGE_EVENT 21 0 rt=281428  SSID: NG700 BSSID: c0:ff:d4:d3:aa:48 nid: 0 state: DISCONNECTED
E/WifiStateMachine( 1039):  ConnectModeState SUPPLICANT_STATE_CHANGE_EVENT 21 0 rt=281428  SSID: NG700 BSSID: c0:ff:d4:d3:aa:48 nid: 0 state: DISCONNECTED
...
E/WifiStateMachine( 1039):  DisconnectedState SUPPLICANT_STATE_CHANGE_EVENT 22 0 rt=281433  SSID:  BSSID: 00:00:00:00:00:00 nid: -1 state: SCANNING
...
D/ConnectivityService( 1039): sendStickyBroadcast: action=android.net.conn.CONNECTIVITY_CHANGE_IMMEDIATE
E/WifiStateMachine( 1039):  ConnectModeState SUPPLICANT_STATE_CHANGE_EVENT 22 0 rt=281437  SSID:  BSSID: 00:00:00:00:00:00 nid: -1 state: SCANNING
D/WifiHS20( 1039): hidePasspointNotification off =false
...
D/TelephonyNetworkFactory-1( 1861): new score 0 for exisiting request NetworkRequest [ id=1, legacyType=-1, [ Capabilities: INTERNET&NOT_RESTRICTED&TRUSTED&NOT_VPN] ]
...
W/ResourcesManager( 7213): Asset path '/system/framework/cneapiclient.jar' does not exist or contains no resources.
W/ResourcesManager( 7213): Asset path '/system/framework/com.lge.mdm.jar' does not exist or contains no resources.
W/ResourcesManager( 7213): Asset path '/system/framework/com.lge.bluetooth.jar' does not exist or contains no resources.
W/ResourcesManager( 7213): Asset path '/system/framework/qcrilhook.jar' does not exist or contains no resources.
W/ResourcesManager( 7213): Asset path '/system/framework/com.broadcom.bt.jar' does not exist or contains no resources.
D/UsbSettingsReceiver( 7213): [AUTORUN] onReceive() : action = android.net.conn.TETHER_STATE_CHANGED
D/UsbSettingsReceiver( 7213): [AUTORUN] sys.usb.config = ptp_only,adb
D/UsbSettingsReceiver( 7213): [AUTORUN] sys.usb.state = ptp_only,adb
D/UsbSettingsReceiver( 7213): [AUTORUN] persist.sys.usb.config = ptp_only,adb
D/UsbSettingsReceiver( 7213): [AUTORUN] onReceive() : app userid = 0, current userid = 0
D/UsbSettingsControl( 7213): [AUTORUN] getUsbConnected() : connected=true
D/UsbSettingsReceiver( 7213): [AUTORUN] onReceive() : availableList=[]
D/UsbSettingsReceiver( 7213): [AUTORUN] onReceive() : activeList=[]
D/UsbSettingsReceiver( 7213): [AUTORUN] onReceive() : errorList=[]
D/UsbSettingsControl( 7213): [AUTORUN] isAutorunTimer() : mAutorunChanging=false
D/DhcpStateMachine( 1039): StoppedState
D/UsbSettingsControl( 7213): [AUTORUN] setTetherStatus() : status=false
D/DhcpStateMachine( 1039): StoppedState{ when=-172ms what=196610 target=com.android.internal.util.StateMachine$SmHandler }
D/PostponalbeReceiver( 6666): WSAndroidSystemIntentReceiver is processing the broadcast action 'android.net.wifi.STATE_CHANGE'.
I/ActivityManager( 1039): Start proc com.lge.sync for broadcast com.lge.sync/.StartReceiver: pid=7240 uid=1000 gids={41000, 9997, 1000, 1028, 1015, 2001, 3002, 3001, 1007, 3003, 1023, 1021, 3004, 3005, 3009, 1010, 1004, 2002, 3008, 1026, 1009, 1027, 1003, 1014, 4002, 1002} abi=armeabi-v7a
...
I/PCSuite ( 7240): [StartReceiver]NETWORK_STATE_CHANGED_ACTION : DISCONNECTED/IDLE
D/PCSuite ( 7240): [StartReceiver][getUpdateNecessity]update = false
D/PCSuite ( 7240): [StartReceiver][LGSW]false, [WIFIUI]false, [WIFI]false, [HOTSPOT]false, [OBEXSERVICE]false
V/WiFiOffLoadBroadcast( 7213): WiFiOffLoadBroadcast: android.net.wifi.STATE_CHANGE
D/LgDataFeature( 7213): LgDataFeature() Constructor: none
D/LgDataFeature( 7213): LgDataFeature() Constructor Done, null
D/WiFiOffLoadBroadcast( 7213): MCCMNC not supported: null
I/ActivityManager( 1039): Start proc com.lge.qremote for broadcast com.lge.qremote/.settings.WiFiStateReceiver: pid=7264 uid=10112 gids={50112, 9997, 1028, 1015, 3003, 3002} abi=armeabi
I/ActivityManager( 1039): Killing 6102:com.lge.appbox.client/u0a11 (adj 15): empty #17
W/libprocessgroup( 1039): failed to open /acct/uid_10011/pid_6102/cgroup.procs: No such file or directory
I/art     ( 1039): Explicit concurrent mark sweep GC freed 54223(2MB) AllocSpace objects, 6(480KB) LOS objects, 33% free, 44MB/66MB, paused 2.701ms total 146.469ms
,W/ResourcesManager( 7264): Asset path '/system/framework/com.lge.mdm.jar' does not exist or contains no resources.
,D/QRemote ( 7264): [QRemoteApplication.java:230:onCreate()] oooooo QRemoteApp onCreate....
,D/QRemote ( 7264): [CarrierUtils.java:858:getHardwareSettings()] oooooo qremote android.os.Build.MODEL = LG-D855
I/QRemote ( 7264): [CarrierUtils.java:859:getHardwareSettings()] oooooo getCountry :: EU
I/QRemote ( 7264): [CarrierUtils.java:860:getHardwareSettings()] oooooo getCarrier :: OPEN
I/QRemote ( 7264): [CarrierUtils.java:861:getHardwareSettings()] oooooo getArea :: COM
D/QRemote ( 7264): [CarrierUtils.java:862:getHardwareSettings()] oooooo Loading Config...
D/QRemote ( 7264): [CarrierUtils.java:876:getHardwareSettings()] oooooo qremote configuration file = R.xml.qremote_conf
,D/QRemote ( 7264): [QRemoteApplication.java:701:updateWidget()] oooooo Widget count is [1]. send broadcast
D/QRemote ( 7264): [WiFiStateReceiver.java:50:onReceive()] oooooo 140626:action:android.net.wifi.STATE_CHANGE
,D/QRemote ( 7264): [WiFiStateReceiver.java:118:onReceive()] oooooo NETWORK_STATE_CHANGED_ACTION
I/QRemote ( 7264): [WiFiStateReceiver.java:199:onReceive()] oooooo The network is disconnected.
,D/PostponalbeReceiver( 6666): WSAndroidSystemIntentReceiver is processing the broadcast action 'android.net.wifi.STATE_CHANGE'.
D/QRemote ( 7264): [QRemoteService.java:196:onCreate()] oooooo 140526:onCreate
I/PCSuite ( 7240): [StartReceiver]NETWORK_STATE_CHANGED_ACTION : DISCONNECTED/IDLE
D/PCSuite ( 7240): [StartReceiver][getUpdateNecessity]update = false
D/PCSuite ( 7240): [StartReceiver][LGSW]false, [WIFIUI]false, [WIFI]false, [HOTSPOT]false, [OBEXSERVICE]false
V/WiFiOffLoadBroadcast( 7213): WiFiOffLoadBroadcast: android.net.wifi.STATE_CHANGE
,D/WiFiOffLoadBroadcast( 7213): MCCMNC not supported: null
D/QRemote ( 7264): [QRemoteService.java:217:onStartCommand()] oooooo 140526:onStartCommand:action:action.application.oncreate. startId:1, flags:0
D/QRemote ( 7264): [WiFiStateReceiver.java:50:onReceive()] oooooo 140626:action:android.net.wifi.STATE_CHANGE
D/QRemote ( 7264): [WiFiStateReceiver.java:118:onReceive()] oooooo NETWORK_STATE_CHANGED_ACTION
I/QRemote ( 7264): [WiFiStateReceiver.java:199:onReceive()] oooooo The network is disconnected.
D/PostponalbeReceiver( 6666): WSAndroidSystemIntentReceiver is processing the broadcast action 'android.net.wifi.STATE_CHANGE'.
...
D/QRemote ( 7264): [WiFiStateReceiver.java:118:onReceive()] oooooo NETWORK_STATE_CHANGED_ACTION
I/QRemote ( 7264): [WiFiStateReceiver.java:199:onReceive()] oooooo The network is disconnected.
V/QRemote ( 7264): [RemoteAppWidgetProvider.java:154:onReceive()] oooooo action name : android.appwidget.action.APPWIDGET_UPDATE
,D/QRemote ( 7264): [RemoteAppWidgetProvider.java:449:onUpdate()] oooooo onUpdate()
D/QRemote ( 7264): [QRemoteApplication.java:86:getControlManager()] oooooo mControlManager is null. make new RemoteControlManager
D/LgDataFeature( 7264): LgDataFeature() Constructor: none
D/LgDataFeature( 7264): LgDataFeature() Constructor Done, null
,V/SoundPool( 7264): SoundPool constructor: maxChannels=2, attr.usage=13, attr.flags=0x0, attr.tags=
V/SoundPool( 7264): load: fd=30, offset=10857164, length=17813, priority=1
V/SoundPool( 7264): create sampleID=1, fd=31, offset=17813 length=10857164
V/SoundPool( 7264): doLoad: loading sample sampleID=1
I/QRemote ( 7264): [RemoteControlManager.java:157:onBindIRService()] oooooo bind
V/SoundPool( 7264): Start decode
V/MediaPlayer[Native]( 7264): decode(31, 10857164, 17813)
...
V/AwesomePlayer(  316): reset_l() 
V/AudioCache(  316): notify(0xb1432cc0, 8, 0, 0)
...
D/QRemote ( 7264): [RemoteControlManager.java:441:setStateInt()] oooooo RemoteControl set [State]11
E/QRemote ( 7264): [RemoteAppWidgetProvider.java:406:isLimitationView()] oooooo rotation : 0
D/QRemote ( 7264): [RemoteAppWidgetProvider.java:457:onUpdate()] oooooo onUpdate orientation:true
,V/LGMDMManager( 7264): Create singleton instance
...
V/OMXCodec(  316): [OMX.google.vorbis.decoder] allocated buffer 0xb54f7d30 on input port
V/OMXCodec(  316): [OMX.google.vorbis.decoder] allocated buffer 0xb54f7d80 on input port
...
V/OMXCodec(  316): [OMX.google.vorbis.decoder] allocated buffer 0xb57c4330 on output port
V/OMXCodec(  316): [OMX.google.vorbis.decoder] allocated buffer 0xb57c44c0 on output port
V/OMXCodec(  316): [OMX.google.vorbis.decoder] allocated buffer 0xb57c4510 on output port
V/OMXCodec(  316): [OMX.google.vorbis.decoder] allocated buffer 0xb57c4600 on output port
...
V/AudioCache(  316): notify(0xb1432cc0, 5, 0, 0)
V/AudioCache(  316): ignored
V/AudioCache(  316): notify(0xb1432cc0, 1, 0, 0)
V/AudioCache(  316): prepared
V/AudioCache(  316): wait - success
V/MediaPlayerSe,rvice(  316): start
...
V/OMXCodec(  316): [OMX.google.vorbis.decoder] Port is disabled, freeing buffer 3044819760
V/OMXCodec(  316): [OMX.google.vorbis.decoder] freeBuffer portIndex=1,bufIndex=0
V/OMXCodec(  316): [OMX.google.vorbis.decoder] Port is disabled, freeing buffer 3044820160
V/OMXCodec(  316): [OMX.google.vorbis.decoder] freeBuffer portIndex=1,bufIndex=0
V/OMXCodec(  316): [OMX.google.vorbis.decoder] Port is disabled, freeing buffer 3044820240
V/OMXCodec(  316): [OMX.google.vorbis.decoder] freeBuffer portIndex=1,bufIndex=0
V/OMXCodec(  316): [OMX.google.vorbis.decoder] Port is disabled, freeing buffer 3044820480
V/OMXCodec(  316): [OMX.google.vorbis.decoder] freeBuffer portIndex=1,bufIndex=0
...
V/OMXCodec(  316): [OMX.google.vorbis.decoder] allocated buffer 0xb57c44c0 on output port
V/OMXCodec(  316): [OMX.google.vorbis.decoder] allocated buffer 0xb57c4330 on output port
V/OMXCodec(  316): [OMX.google.vorbis.decoder] allocated buffer 0xb57c4740 on output port
...
V/AudioCache(  316): notify(0xb1432cc0, 6, 0, 0)
V/AudioCache(  316): ignored
V/MediaPlayerService(  316): wait for playback complete
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab602000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab603000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab604000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab605000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab606000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab607000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab608000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab609000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab60a000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab60b000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab60c000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab60d000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab60e000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab60f000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab610000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab611000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab612000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab613000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab614000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab615000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab616000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab617000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab618000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab619000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab61a000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab61b000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab61c000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab61d000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab61e000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab61f000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab620000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab621000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab622000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab623000, 0xb174d000, 4096)
,V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab624000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab625000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab626000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab627000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab628000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab629000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab62a000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab62b000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab62c000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab62d000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab62e000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab62f000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab630000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab631000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab632000, 0xb174d000, 4096)
V/AudioCache(  316): write(0xb174d000, 4096)
V/AudioCache(  316): memcpy(0xab633000, 0xb174d000, 4096)
...
V/AudioCache(  316): write(0xb174d000, 280)
V/AudioCache(  316): memcpy(0xab634000, 0xb174d000, 280)
...
V/AudioCache(  316): notify(0xb1432cc0, 2, 0, 0)
V/AudioCache(  316): playback complete
V/AwesomePlayer(  316): pause_l() 
V/AudioCache(  316): notify(0xb1432cc0, 7, 0, 0)
V/AudioCache(  316): ignored
V/AwesomePlayer(  316): cancelPlayerEvents
V/AudioCache(  316): wait - success
...
V/OMXCodec(  316): [OMX.google.vorbis.decoder] freeing buffer 0xb54f7d80 on port 0
V/OMXCodec(  316): [OMX.google.vorbis.decoder] freeBuffer portIndex=0,bufIndex=2
V/OMXCodec(  316): [OMX.google.vorbis.decoder] freeing buffer 0xb54f7d30 on port 0
...
V/OMXCodec(  316): [OMX.google.vorbis.decoder] freeBuffersOnPort portIndex=1
V/OMXCodec(  316): [OMX.google.vorbis.decoder] freeing buffer 0xb57c4740 on port 1
V/OMXCodec(  316): [OMX.google.vorbis.decoder] freeBuffer portIndex=1,bufIndex=3
V/OMXCodec(  316): [OMX.google.vorbis.decoder] freeing buffer 0xb57c4330 on port 1
V/OMXCodec(  316): [OMX.google.vorbis.decoder] freeBuffer portIndex=1,bufIndex=2
V/OMXCodec(  316): [OMX.google.vorbis.decoder] freeing buffer 0xb57c44c0 on port 1
V/OMXCodec(  316): [OMX.google.vorbis.decoder] freeBuffer portIndex=1,bufIndex=1
V/OMXCodec(  316): [OMX.google.vorbis.decoder] freeing buffer 0xb57c4510 on port 1
V/OMXCodec(  316): [OMX.google.vorbis.decoder] freeBuffer portIndex=1,bufIndex=0
...
V/AwesomePlayer(  316): reset_l() 
V/AwesomePlayer(  316): cancelPlayerEvents
V/SoundPool( 7264): close(31)
V/SoundPool( 7264): pointer = 0x9ffdc000, size = 205080, sampleRate = 48000, numChannels = 2
D/QRemote ( 7264): [RemoteAppWidgetProvider.java:480:onUpdate()] oooooo updateAppWidget to loading view
D/QRemote ( 7264): [RemoteAppWidgetProvider.java:486:onUpdate()] oooooo 140510:RetrieveDevices is not complete. Just waiting
D/QRemote ( 7264): [RemoteAppWidgetProvider.java:499:onUpdate()] oooooo 140514:alarm set after 5000ms:1070
...
I/QRemote ( 7264): [RemoteControlManager.java:183:onServiceConnected()] oooooo start
...
I/QRemote ( 7264): [RemoteControlManager.java:660:QSSetupIsReady()] oooooo 140517:sdkIsReady callback... get functions. Result:0
D/UEI.SmartControl( 6885): -----service ready thread exits
D/QRemote ( 7264): [RemoteControlManager.java:388:handleMessage()] oooooo 140510:START_SESSION
D/QRemote ( 7264): [RemoteControlManager.java:394:handleMessage()] oooooo 140510:send retrieve msg
D/QRemote ( 7264): [RemoteControlManager.java:322:handleMessage()] oooooo 140510:handler call retrieveDevices
D/QRemote ( 7264): [RemoteControlManager.java:336:retrieveDevices()] oooooo retrieveDevices: start
I/UEI.SmartControl( 6885): ------ IControl API: 8
D/QRemote ( 7264): [RemoteControlManager.java:340:retrieveDevices()] oooooo retrieveDevices: 0
D/QRemote ( 7264): [RemoteControlManager.java:345:retrieveDevices()] oooooo retrieveDevices complete:true
,D/QRemote ( 7264): [RemoteControlManager.java:353:retrieveDevices()] oooooo retrieveDevices: notifyDataSetChanged()
D/QRemote ( 7264): [QRemoteApplication.java:145:onRemoteControlStateChanged()] oooooo onRemoteControlStateChanged called in QRemoteApp
D/QRemote ( 7264): [QRemoteApplication.java:158:onRemoteControlStateChanged()] oooooo Widget count is [1]. send broadcast
D/QRemote ( 7264): [QRemoteApplication.java:160:onRemoteControlStateChanged()] oooooo Widget[0]:3
D/QRemote ( 7264): [QRemoteApplication.java:188:onRemoteControlStateChanged()] oooooo 140526:onRemoteControlStateChanged&sdkIsReady. stop Service
V/QRemote ( 7264): [RemoteAppWidgetProvider.java:154:onReceive()] oooooo action name : android.appwidget.action.APPWIDGET_UPDATE
D/QRemote ( 7264): [RemoteAppWidgetProvider.java:449:onUpdate()] oooooo onUpdate()
,E/QRemote ( 7264): [RemoteAppWidgetProvider.java:406:isLimitationView()] oooooo rotation : 0
D/QRemote ( 7264): [RemoteAppWidgetProvider.java:457:onUpdate()] oooooo onUpdate orientation:true
D/QRemote ( 7264): [RemoteAppWidgetProvider.java:480:onUpdate()] oooooo updateAppWidget to loading view
D/QRemote ( 7264): [RemoteAppWidgetProvider.java:506:onUpdate()] oooooo 140510:RetrieveDevices complete. Start loading
D/QRemote ( 7264): [RemoteAppWidgetProvider.java:508:onUpdate()] oooooo 140510:appWidgetIds[0]:3 loading
D/QRemote ( 7264): [RemoteAppWidgetManager.java:41:startLoading()] oooooo 140518:widgetId[3] loading start at [1452688874489]
D/QRemote ( 7264): [QRemoteService.java:207:onDestroy()] oooooo 140526:onDestroy
I/ActivityManager( 1039): Killing 6123:com.android.contacts/u0a19 (adj 15): empty #17
,D/QRemote ( 7264): [RemoteAppWidgetManager.java:239:doInBackground()] oooooo 140407:doinBack arr:0
,W/libprocessgroup( 1039): failed to open /acct/uid_10019/pid_6123/cgroup.procs: No such file or directory
,V/QRemote ( 7264): [RemoteAppWidgetProvider.java:154:onReceive()] oooooo action name : com.lge.qremote.action.widget_ui_update
,E/QRemote ( 7264): [RemoteAppWidgetProvider.java:406:isLimitationView()] oooooo rotation : 0
D/QRemote ( 7264): [RemoteAppWidgetProvider.java:171:onReceive()] oooooo total:0
D/QRemote ( 7264): [RemoteAppWidgetProvider.java:172:onReceive()] oooooo selected:0
D/QRemote ( 7264): [RemoteAppWidgetProvider.java:173:onReceive()] oooooo arr:[]
D/QRemote ( 7264): [RemoteAppWidgetProvider.java:174:onReceive()] oooooo appWidgetId:3
D/QRemote ( 7264): [RemoteAppWidgetProvider.java:815:updateRemoteViews()] oooooo UpdateRemoteViews3:widgetId:3
D/QRemote ( 7264): [RemoteAppWidgetProvider.java:986:updateRemoteViews()] oooooo updateAppWidget5:widgetId:3]
...
E/WifiStateMachine( 1039):  DisconnectedState SUPPLICANT_STATE_CHANGE_EVENT 26 0 rt=283541  SSID:  BSSID: 00:00:00:00:00:00 nid: -1 state: ASSOCIATING
E/WifiStateMachine( 1039):  ConnectModeState SUPPLICANT_STATE_CHANGE_EVENT 26 0 rt=283545  SSID:  BSSID: 00:00:00:00:00:00 nid: -1 state: ASSOCIATING
...
D/QRemote ( 7264): [WiFiStateReceiver.java:50:onReceive()] oooooo 140626:action:android.net.wifi.STATE_CHANGE
D/QRemote ( 7264): [WiFiStateReceiver.java:118:onReceive()] oooooo NETWORK_STATE_CHANGED_ACTION
I/QRemote ( 7264): [WiFiStateReceiver.java:201:onReceive()] oooooo The network is not connected. Don't handle that intent.
...
E/WifiStateMachine( 1039):  DisconnectedState SUPPLICANT_STATE_CHANGE_EVENT 27 0 rt=283652  SSID: NG700 BSSID: 00:00:00:00:00:00 nid: 0 state: ASSOCIATED
...
E/WifiStateMachine( 1039):  ConnectModeState SUPPLICANT_STATE_CHANGE_EVENT 27 0 rt=283653  SSID: NG700 BSSID: 00:00:00:00:00:00 nid: 0 state: ASSOCIATED
E/WifiStateMachine( 1039):  DisconnectedState CMD_ASSOCIATED_BSSID 28 0 BSSID=c0:ff:d4:d3:aa:48 Target=any roam=0 rt=283653
E/WifiStateMachine( 1039):  ConnectModeState CMD_ASSOCIATED_BSSID 28 0 BSSID=c0:ff:d4:d3:aa:48 Target=any roam=0 rt=283653
E/WifiStateMachine( 1039):  DriverStartedState CMD_ASSOCIATED_BSSID 28 0 BSSID=c0:ff:d4:d3:aa:48 Target=any roam=0 rt=283653
E/WifiStateMachine( 1039):  SupplicantStartedState CMD_ASSOCIATED_BSSID 28 0 BSSID=c0:ff:d4:d3:aa:48 Target=any roam=0 rt=283654
E/WifiStateMachine( 1039):  DefaultState CMD_ASSOCIATED_BSSID 28 0 BSSID=c0:ff:d4:d3:aa:48 Target=any roam=0 rt=283654
...
E/WifiStateMachine( 1039):  DisconnectedState SUPPLICANT_STATE_CHANGE_EVENT 29 0 rt=283654  SSID: NG700 BSSID: c0:ff:d4:d3:aa:48 nid: 0 state: FOUR_WAY_HANDSHAKE
...
E/WifiStateMachine( 1039):  ConnectModeState SUPPLICANT_STATE_CHANGE_EVENT 29 0 rt=283659  SSID: NG700 BSSID: c0:ff:d4:d3:aa:48 nid: 0 state: FOUR_WAY_HANDSHAKE
D/WifiServerServiceExt( 1039): SUPPLICANT_STATE_CHANGED_ACTION
D/WifiServerServiceExt( 1039): setSupplicantStateASSOCIATED
D/PostponalbeReceiver( 6666): WSAndroidSystemIntentReceiver is processing the broadcast action 'android.net.wifi.STATE_CHANGE'.
D/StatusBar.NetworkController( 1465): refreshViews: Data not connected!! Set no data type icon / Roaming
E/WifiStateMachine( 1039):  DisconnectedState SUPPLICANT_STATE_CHANGE_EVENT 30 0 rt=283666  SSID: NG700 BSSID: c0:ff:d4:d3:aa:48 nid: 0 state: GROUP_HANDSHAKE
E/WifiStateMachine( 1039):  ConnectModeState SUPPLICANT_STATE_CHANGE_EVENT 30 0 rt=283666  SSID: NG700 BSSID: c0:ff:d4:d3:aa:48 nid: 0 state: GROUP_HANDSHAKE
E/WifiStateMachine( 1039):  DisconnectedState NETWORK_CONNECTION_EVENT 0 0 null nid=-1 rt=283666
E/WifiStateMachine( 1039):  ConnectModeState NETWORK_CONNECTION_EVENT 0 0 null nid=-1 rt=283667
...
E/WifiStateMachine( 1039):  ObtainingIpState SUPPLICANT_STATE_CHANGE_EVENT 33 0 rt=283708  SSID: NG700 BSSID: c0:ff:d4:d3:aa:48 nid: 0 state: COMPLETED
E/WifiStateMachine( 1039):  L2ConnectedState SUPPLICANT_STATE_CHANGE_EVENT 33 0 rt=283708  SSID: NG700 BSSID: c0:ff:d4:d3:aa:48 nid: 0 state: COMPLETED
E/WifiStateMachine( 1039):  ConnectModeState SUPPLICANT_STATE_CHANGE_EVENT 33 0 rt=283708  SSID: NG700 BSSID: c0:ff:d4:d3:aa:48 nid: 0 state: COMPLETED
,D/WifiServerServiceExt( 1039): SUPPLICANT_STATE_CHANGED_ACTION
...
E/WifiStateMachine( 1039):  ObtainingIpState SUPPLICANT_STATE_CHANGE_EVENT 34 0 rt=283712  SSID: NG700 BSSID: c0:ff:d4:d3:aa:48 nid: 0 state: COMPLETED
E/WifiStateMachine( 1039):  L2ConnectedState SUPPLICANT_STATE_CHANGE_EVENT 34 0 rt=283712  SSID: NG700 BSSID: c0:ff:d4:d3:aa:48 nid: 0 state: COMPLETED
E/WifiStateMachine( 1039):  ConnectModeState SUPPLICANT_STATE_CHANGE_EVENT 34 0 rt=283713  SSID: NG700 BSSID: c0:ff:d4:d3:aa:48 nid: 0 state: COMPLETED
...
D/UsbSettingsReceiver( 7213): [AUTORUN] onReceive() : app userid = 0, current userid = 0
D/UsbSettingsControl( 7213): [AUTORUN] getUsbConnected() : connected=true
D/UsbSettingsReceiver( 7213): [AUTORUN] onReceive() : availableList=[wlan0]
D/UsbSettingsReceiver( 7213): [AUTORUN] onReceive() : activeList=[]
D/UsbSettingsReceiver( 7213): [AUTORUN] onReceive() : errorList=[]
D/UsbSettingsControl( 7213): [AUTORUN] isAutorunTimer() : mAutorunChanging=false
D/UsbSettingsReceiver( 7213): [AUTORUN] onReceive() : TetherState Changed=wlan0
D/UsbSettingsControl( 7213): [AUTORUN] setTetherStatus() : status=false
D/PostponalbeReceiver( 6666): WSAndroidSystemIntentReceiver is processing the broadcast action 'android.net.wifi.STATE_CHANGE'.
V/WiFiOffLoadBroadcast( 7213): WiFiOffLoadBroadcast: android.net.wifi.STATE_CHANGE
,D/WiFiOffLoadBroadcast( 7213): MCCMNC not supported: null
...
,D/LGWifiP2pService( 1039): InactiveState{ when=-2ms what=143375 arg1=1 arg2=196615 obj=android.net.DhcpStateMachine@e1efc0a target=com.android.internal.util.StateMachine$SmHandler }
D/CommandListener(  312): Setting iface cfg
D/CommandListener(  312): Trying to bring up wlan0
D/LGWifiP2pService( 1039): P2pEnabledState{ when=-3ms what=143375 arg1=1 arg2=196615 obj=android.net.DhcpStateMachine@e1efc0a target=com.android.internal.util.StateMachine$SmHandler }
...
,W/dsqn    ( 7322): type=1400 audit(0.0:167): avc: denied { read write } for path="/dev/block/mmcblk0" dev="tmpfs" ino=6849 scontext=u:r:dsqn:s0 tcontext=u:object_r:mmc_block_device:s0 tclass=blk_file
W/dsqn    ( 7322): type=1400 audit(0.0:168): avc: denied { read write } for path="/dev/block/mmcblk0" dev="tmpfs" ino=6849 scontext=u:r:dsqn:s0 tcontext=u:object_r:mmc_block_device:s0 tclass=blk_file
...
I/QRemote ( 7264): [WiFiStateReceiver.java:201:onReceive()] oooooo The network is not connected. Don't handle that intent.
D/PostponalbeReceiver( 6666): WSAndroidSystemIntentReceiver is processing the broadcast action 'android.net.wifi.STATE_CHANGE'.
,I/PCSuite ( 7240): [StartReceiver]NETWORK_STATE_CHANGED_ACTION : CONNECTED
D/PCSuite ( 7240): [StartReceiver][LGSW]false, [WIFIUI]false, [WIFI]true, [HOTSPOT]false, [OBEXSERVICE]false
V/WiFiOffLoadBroadcast( 7213): WiFiOffLoadBroadcast: android.net.wifi.STATE_CHANGE
,D/WiFiOffLoadBroadcast( 7213): MCCMNC not supported: null
D/QRemote ( 7264): [WiFiStateReceiver.java:50:onReceive()] oooooo 140626:action:android.net.wifi.STATE_CHANGE
D/QRemote ( 7264): [WiFiStateReceiver.java:118:onReceive()] oooooo NETWORK_STATE_CHANGED_ACTION
D/QRemote ( 7264): [WiFiStateReceiver.java:123:onReceive()] oooooo The network is connected.
I/QRemote ( 7264): [Constants.java:311:getHomeWifiIdList()] oooooo There are not stored home Wi-Fi networks.
I/QRemote ( 7264): [WiFiStateReceiver.java:178:onReceive()] oooooo There are no stored BSSIDs.
D/PostponalbeReceiver( 6666): WSAndroidSystemIntentReceiver is processing the broadcast action 'android.net.wifi.STATE_CHANGE'.
I/PCSuite ( 7240): [StartReceiver]NETWORK_STATE_CHANGED_ACTION : CONNECTED
,D/PCSuite ( 7240): [StartReceiver][LGSW]false, [WIFIUI]false, [WIFI]true, [HOTSPOT]false, [OBEXSERVICE]false
V/WiFiOffLoadBroadcast( 7213): WiFiOffLoadBroadcast: android.net.wifi.STATE_CHANGE
...
,D/NetworkMonitor NetworkAgentInfo [WIFI () - null]( 1039): isCaptivePortal: ret=204 headers={null=[HTTP/1.1 204 No Content], Content-Length=[0], Date=[Wed, 13 Jan 2016 12:41:15 GMT], Server=[GFE/2.0], X-Android-Received-Millis=[1452688875435], X-Android-Response-Source=[NETWORK 204], X-Android-Sent-Millis=[1452688875413]}
...
W/dhcpcd  ( 7328): type=1400 audit(0.0:169): avc: denied { read write } for path="/dev/block/mmcblk0" dev="tmpfs" ino=6849 scontext=u:r:dhcp:s0 tcontext=u:object_r:mmc_block_device:s0 tclass=blk_file
,W/dhcpcd  ( 7328): type=1400 audit(0.0:170): avc: denied { read write } for path="/dev/block/mmcblk0" dev="tmpfs" ino=6849 scontext=u:r:dhcp:s0 tcontext=u:object_r:mmc_block_device:s0 tclass=blk_file
...
D/dhcpcd  ( 7328): wlan0: sending REQUEST (xid 0x1bed96ca), next in 3.27 seconds
...
D/PostponalbeReceiver( 6666): WSAndroidSystemIntentReceiver is processing the broadcast action 'android.net.conn.CONNECTIVITY_CHANGE'.
W/ContextImpl( 6666): Calling a method in the system process without a qualified user: android.app.ContextImpl.startService:1757 android.content.ContextWrapper.startService:515 com.wavesecure.core.r.run:-1 java.util.concurrent.Executors$RunnableAdapter.call:422 java.util.concurrent.FutureTask.run:237 
,I/NetworkMonitor( 5501): type=WIFI subType= reason=null isConnected=true
,I/NetworkMonitor( 5501): type=WIFI subType= reason=null isConnected=true
,I/ActivityManager( 1039): Start proc com.lge.appbox.client for broadcast com.lge.appbox.client/com.lge.appbox.receiver.NetworkStateForAutoUpdateMonitor: pid=7357 uid=10011 gids={50011, 9997, 3003, 1028, 1015, 2001} abi=armeabi-v7a
,D/GpsLocationProvider( 1039): receive broadcast intent, action: android.net.conn.CONNECTIVITY_CHANGE
...
D/GpsLocationProvider( 1039): updateNetworkState available info: [type: WIFI[], state: CONNECTED/CONNECTED, reason: (unspecified), extra: "NG700", roaming: false, failover: false, isAvailable: true, isConnectedToProvisioningNetwork: false]
,I/art     (  389): Explicit concurrent mark sweep GC freed 709(30KB) AllocSpace objects, 0(0B) LOS objects, 54% free, 26MB/58MB, paused 461us total 28.872ms
,I/AppUp4:AppBoxCP( 7357): onCreate
W/AppUp4:DB( 7357):  [AppBoxDatabaseHelper] construct
,I/AppUp4:DB( 7357):  setFingerPrint start
I/AppUp4:DB( 7357):  newfinger = lge/g3_global_com/g3:5.0/LRX21R.A1421650137/1421650137:user/release-keys SDK version = 21
I/art     (  389): Explicit concurrent mark sweep GC freed 5(160B) AllocSpace objects, 0(0B) LOS objects, 54% free, 26MB/58MB, paused 397us total 18.538ms
I/AppUp4:DB( 7357):  beforefinger = lge/g3_global_com/g3:5.0/LRX21R.A1421650137/1421650137:user/release-keys
I/AppUp4:DB( 7357):  SDK version = 21
...
,I/art     (  389): Explicit concurrent mark sweep GC freed 5(160B) AllocSpace objects, 0(0B) LOS objects, 54% free, 26MB/58MB, paused 352us total 16.315ms
D/LgDataFeature( 7357): LgDataFeature() Constructor: none
,D/LgDataFeature( 7357): LgDataFeature() Constructor Done, null
,D/AppUp4:CustFacade( 7357): Context : android.app.ReceiverRestrictedContext@16f9c11
D/AppUp4:CustFacade( 7357): isCustomizationCompleted : false
D/AppUp4:CustFacade( 7357): isPhone : true
...
I/ActivityManager( 1039): Killing 6556:com.android.defcontainer/u0a4 (adj 15): empty #17
...
,D/LGDMClient( 4339): [DmDeviceActionReceiver.java] [onReceive()] : [128] : Device Action Receiver android.net.conn.CONNECTIVITY_CHANGE
D/LGDMClient( 4339): [DmDeviceActionReceiver.java] [doAction()] : [60] : Device Action doAction
W/ContextImpl( 4339): Calling a method in the system process without a qualified user: android.app.ContextImpl.startService:1757 android.content.ContextWrapper.startService:515 com.lge.lgdmsclient.dmclient.agent.DmDeviceActionReceiver.doAction:78 com.lge.lgdmsclient.dmclient.agent.DmDeviceActionReceiver.onReceive:132 android.app.ActivityThread.handleReceiver:2586 
,W/libprocessgroup( 1039): failed to open /acct/uid_10004/pid_6556/cgroup.procs: No such file or directory
W/ContextImpl( 4339): Calling a method in the system process without a qualified user: android.app.ContextImpl.startService:1757 android.content.ContextWrapper.startService:515 com.lge.lgdmsclient.dmclient.agent.DmDeviceActionReceiver.doAction:82 com.lge.lgdmsclient.dmclient.agent.DmDeviceActionReceiver.onReceive:132 android.app.ActivityThread.handleReceiver:2586 
,V/DownloadManager( 3400): Received broadcast intent for android.net.conn.CONNECTIVITY_CHANGE
D/LGDMClient( 4339): [DmUtil.java] [getServiceTypeBasedOnAgentState()] : [672] : iAgentState=3, isUserType=1
,V/DownloadManager( 3400): DownloadService onCreate
D/LGDMClient( 4339): [GCMRegisterService.java] [onHandleIntent()] : [47] : Intent : android.net.conn.CONNECTIVITY_CHANGE
D/LGDMClient( 4339): [GCMRegisterService.java] [onHandleIntent()] : [56] : ConnectivityManager is not null
I/LGDMClient( 4339): [DmServiceProcessor.java] [processNetworkChanged()] : [91] : networkStateChanged [DeviceServiceType:Full Mode]--> NetworkType : WIFI is connected.
...
,V/DownloadManager( 3400): created cursor android.database.sqlite.SQLiteCursor@233ecfdc on behalf of 3400
W/ContextImpl( 4339): Calling a method in the system process without a qualified user: android.app.ContextImpl.startService:1757 android.content.ContextWrapper.startService:515 com.lge.lgdmsclient.service.DmServiceProcessor.processNetworkChanged:141 com.lge.lgdmsclient.service.DmServiceProcessor.onHandleIntent:180 android.app.IntentService$ServiceHandler.handleMessage:65 
E/LGDMClient( 4339): [DmNotiService.java] [onCreate()] : [148] : DmNotiService.onCreate()
D/LGDMClient( 4339): [DmNotiService.java] [onStartCommand()] : [182] : in the new onStartCommand()
D/LGDMClient( 4339): [DmNotiService.java] [handleStart()] : [203] : IN SERVICE IntentActioncom.lge.dm.dmclient.intent.SYSTEM_NETWORK_CHANGED
...
V/DownloadManager( 3400): created cursor android.database.sqlite.SQLiteCursor@317eae6b on behalf of 3400
V/DownloadManager( 3400): created cursor android.database.sqlite.SQLiteCursor@3dd70dc8 on behalf of 3400
...
I/ActivityManager( 1039): Start proc com.lge.formmanager for broadcast com.lge.formmanager/.FormServiceReceiver: pid=7383 uid=10026 gids={50026, 9997, 3003, 1028} abi=armeabi-v7a
...
,I/ActivityManager( 1039): Start proc com.android.chrome for broadcast com.android.chrome/com.google.android.apps.chrome.precache.PrecacheServiceLauncher: pid=7407 uid=10057 gids={50057, 9997, 3003, 1028, 1015} abi=armeabi-v7a
...
,I/ActivityManager( 1039): Start proc com.lge.drmservice for broadcast com.lge.drmservice/.DrmBroadcastReceiver: pid=7435 uid=10062 gids={50062, 9997, 4002, 3003, 1028} abi=armeabi-v7a
,I/ActivityManager( 1039): Killing 6751:com.android.gallery3d/u0a27 (adj 15): empty #17
...
,W/libprocessgroup( 1039): failed to open /acct/uid_10027/pid_6751/cgroup.procs: No such file or directory
...
I/ActivityManager( 1039): Start proc com.lge.sizechangable.weather for broadcast com.lge.sizechangable.weather/.layout.WeatherWidget: pid=7465 uid=10085 gids={50085, 9997, 3003, 1028, 1015} abi=armeabi-v7a
,I/ActivityManager( 1039): Killing 6774:com.google.android.apps.docs/u0a61 (adj 15): empty #17
W/libprocessgroup( 1039): failed to open /acct/uid_10061/pid_6774/cgroup.procs: No such file or directory
,I/ActivityManager( 1039): Killing 6824:com.lge.lockscreensettings/u0a80 (adj 15): empty #17
,I/art     ( 7465): Almond Protected OAT
W/libprocessgroup( 1039): failed to open /acct/uid_10080/pid_6824/cgroup.procs: No such file or directory
,D/WeatherApplication( 7465): removeAccount
D/WeatherApplication( 7465): Account.length = 0
E/WeatherApplication( 7465): OPERATOR:OPEN
D/WeatherAncestor( 7465): 2 : onReceive, action: android.net.conn.CONNECTIVITY_CHANGE, Time(hour:min:sec) 13:41:17
...
D/WeatherAncestor( 7465): 2 : onReceive has processed, action: android.net.conn.CONNECTIVITY_CHANGE, Time(hour:min:sec) 13:41:17
,I/ActivityManager( 1039): Start proc com.google.android.apps.magazines for broadcast com.google.android.apps.magazines/com.google.apps.dots.android.newsstand.appwidget.NewsWidgetProvider: pid=7486 uid=10093 gids={50093, 9997, 3003, 1028, 1015} abi=armeabi-v7a
,I/ActivityManager( 1039): Killing 6919:com.lge.eula/1000 (adj 15): empty #17
W/libprocessgroup( 1039): failed to open /acct/uid_1000/pid_6919/cgroup.procs: No such file or directory
...
,W/ContextImpl( 7486): Failed to ensure directory: /storage/external_SD/Android/data/com.google.android.apps.magazines/cache
E/VoldCmdListener(  279): [LGE][VOLD][CommandListener.cpp][VolumeCmd::runCommand()] argv[0]:volume, argv[1]:mkdirs, argc:3
E/Vold    (  279): Failed to find mounted volume for /storage/external_SD/Android/data/com.google.android.apps.magazines/files/
W/Vold    (  279): Returning OperationFailed - no handler for errno 0
W/ContextImpl( 7486): Failed to ensure directory: /storage/external_SD/Android/data/com.google.android.apps.magazines/files
E/VoldCmdListener(  279): [LGE][VOLD][CommandListener.cpp][VolumeCmd::runCommand()] argv[0]:volume, argv[1]:mkdirs, argc:3
E/Vold    (  279): Failed to find mounted volume for /storage/external_SD/Android/data/com.google.android.apps.magazines/cache/
W/Vold    (  279): Returning OperationFailed - no handler for errno 0
W/ContextImpl( 7486): Failed to ensure directory: /storage/external_SD/Android/data/com.google.android.apps.magazines/cache
...
W/Vold    (  279): Returning OperationFailed - no handler for errno 0
W/ContextImpl( 7486): Failed to ensure directory: /storage/external_SD/Android/data/com.google.android.apps.magazines/files
I/WebViewFactory( 7486): Loading com.google.android.webview version 37 (1589900-arm) (code 110601)
I/LibraryLoader( 7486): Loading: webviewchromium
I/LibraryLoader( 7486): Time to load native libraries: 4 ms (timestamps 6362-6366)
I/LibraryLoader( 7486): Expected native library version number "",actual native library version number ""
,V/WebViewChromiumFactoryProvider( 7486): Binding Chromium to main looper Looper (main, tid 1) {1cd68f80}
I/LibraryLoader( 7486): Expected native library version number "",actual native library version number ""
I/chromium( 7486): [INFO:library_loader_hooks.cc(106)] Chromium logging enabled: level = 0, default verbosity = 0
I/BrowserStartupController( 7486): Initializing chromium process, renderers=0
W/art     ( 7486): Attempt to remove local handle scope entry from IRT, ignoring
,W/chromium( 7486): [WARNING:resource_bundle.cc(315)] locale_file_path.empty()
I/chromium( 7486): [INFO:aw_browser_main_parts.cc(63)] Load from apk succesful, fd=38 off=46780 len=2953
I/chromium( 7486): [INFO:aw_browser_main_parts.cc(78)] Loading webviewchromium.pak from, fd:39 off:229536 len:643667
V/AudioPolicyService(  316): registerClient() client 0xb57bb9a0, uid 10093
...
W/AudioManagerAndroid( 7486): Requires BLUETOOTH permission
...
I/Adreno-EGL( 7486): Build Date: 12/12/14 금
I/Adreno-EGL( 7486): Local Branch: LA.BF.1.1_RB1.05.00.00.002.031_20141212_01821442
I/Adreno-EGL( 7486): Remote Branch: 
I/Adreno-EGL( 7486): Local Patches: 
I/Adreno-EGL( 7486): Reconstruct Branch: 
,I/NSApplication( 7486): Starting up...
...
,D/AppUp4:CustFacade( 7357): isPhone : true
D/AppUp4:CustModeStarterReceiver( 7357): begin check event
I/AppUp4:CustModeStarterReceiver( 7357): Event For GoodConnectivity, noConnectivity : false, but skip! 
D/LGDMClient( 4339): [DmDeviceActionReceiver.java] [onReceive()] : [128] : Device Action Receiver android.net.conn.CONNECTIVITY_CHANGE
D/LGDMClient( 4339): [DmDeviceActionReceiver.java] [doAction()] : [60] : Device Action doAction
,W/ContextImpl( 4339): Calling a method in the system process without a qualified user: android.app.ContextImpl.startService:1757 android.content.ContextWrapper.startService:515 com.lge.lgdmsclient.dmclient.agent.DmDeviceActionReceiver.doAction:78 com.lge.lgdmsclient.dmclient.agent.DmDeviceActionReceiver.onReceive:132 android.app.ActivityThread.handleReceiver:2586 
W/ContextImpl( 4339): Calling a method in the system process without a qualified user: android.app.ContextImpl.startService:1757 android.content.ContextWrapper.startService:515 com.lge.lgdmsclient.dmclient.agent.DmDeviceActionReceiver.doAction:82 com.lge.lgdmsclient.dmclient.agent.DmDeviceActionReceiver.onReceive:132 android.app.ActivityThread.handleReceiver:2586 
...
I/DownloadManager( 3400): in removeSpuriousFiles
V/DownloadManager( 3400): starting query, database is not null; projection[0] is _data; selection is null; selectionArgs is null; sort is null.
,V/DownloadManager( 3400): created cursor android.database.sqlite.SQLiteCursor@17eb0d86 on behalf of 3400
I/DownloadManager( 3400): in removeSpuriousFiles, preserving file /storage/emulated/0/.dwnld/LGMyGuide_4.40.09_COM_COM_20150430011620058_RELG-D855.apk
I/DownloadManager( 3400): in removeSpuriousFiles, preserving file /storage/emulated/0/.dwnld/LGBackup_4.50.37_COM_COM_20150608234245157.apk
I/DownloadManager( 3400): in removeSpuriousFiles, preserving file /storage/emulated/0/.dwnld/CalendarProvider_4.2.8_COM_COM_20150304234552863_RELG-D855.apk
W/ContextImpl( 4339): Calling a method in the system process without a qualified user: android.app.ContextImpl.startService:1757 android.content.ContextWrapper.startService:515 com.lge.lgdmsclient.service.DmServiceProcessor.processNetworkChanged:141 com.lge.lgdmsclient.service.DmServiceProcessor.onHandleIntent:180 android.app.IntentService$ServiceHandler.handleMessage:65 
...
,D/LGDMClient( 4339): [DmNotiService.java] [onStartCommand()] : [182] : in the new onStartCommand()
D/LGDMClient( 4339): [DmNotiService.java] [handleStart()] : [203] : IN SERVICE IntentActioncom.lge.dm.dmclient.intent.SYSTEM_NETWORK_CHANGED
V/DownloadManager( 3400): created cursor android.database.sqlite.SQLiteCursor@8d7c647 on behalf of 3400
V/DownloadManager( 3400): DownloadService onStartCommand
V/DownloadManager( 3400): starting query, database is not null; projection is null; selection is null; selectionArgs is null; sort is null.
W/Settings( 6721): Setting airplane_mode_on has moved from android.provider.Settings.System to android.provider.Settings.Global, returning read-only value.
...
I/LgeMiscReceiver( 3355): networkInfo.isConnected() = false
W/Settings( 6721): Setting airplane_mode_on has moved from android.provider.Settings.System to android.provider.Settings.Global, returning read-only value.
V/DownloadManager( 3400): created cursor android.database.sqlite.SQLiteCursor@2dda7c12 on behalf of 3400
...
,D/WeatherAncestor( 7465): 2 : onReceive, action: android.net.conn.CONNECTIVITY_CHANGE, Time(hour:min:sec) 13:41:18
D/Weather.Utils( 7465): 2 : the weather widgets(using time tick) are gone.
D/Weather.Utils( 7465): 2 : All the weather widget is gone.
D/UpdateThreadPoolManager( 7465): 2 : This is isUpdating : false
D/WeatherAncestor( 7465): connectivity changed - connection : true
D/WeatherService( 7465): 2 : isServiceAlived():false forecastCache:com.lge.sizechangable.weather.data.core.ForecastDataCache@33475377
D/ForecastDataCache( 7465): 2 : lastUpdatedTime: 1430558561343
D/ForecastDataCache( 7465): 2 : currentPackageVersion: 4.40.4
D/ForecastDataCache( 7465): 2 : Cache is up-to-date, count: 0
D/Weather_cast( 7465): 2 : isUpdateNeedForAlarm : no city return false
D/WeatherAncestor( 7465): 2 : onReceive has processed, action: android.net.conn.CONNECTIVITY_CHANGE, Time(hour:min:sec) 13:41:18
V/DownloadManager( 3400): processing inserted download 1
V/DownloadManager( 3400): processing inserted download 4
V/DownloadManager( 3400): processing inserted download 7
V/DownloadManager( 3400): processing inserted download 8
...
D/QuickStatusbarLayout( 1405): child = android.widget.LinearLayout{1a651899 V.E..... ......ID 0,0-798,100 #7f0f0041 app:id/notification_icon_area} ,w = 798
D/GpsLocationProvider( 1039): updateNetworkState available info: [type: WIFI[], state: CONNECTED/CONNECTED, reason: (unspecified), extra: "NG700", roaming: false, failover: false, isAvailable: true, isConnectedToProvisioningNetwork: false]
I/NetworkMonitor( 5501): type=WIFI subType= reason=null isConnected=true
D/ChimeraCfgMgr( 2333): Loading module com.google.android.gms.kids from APK com.google.android.gms
,D/PostponalbeReceiver( 6666): WSAndroidSystemIntentReceiver is processing the broadcast action 'android.net.conn.CONNECTIVITY_CHANGE'.
...
I/DownloadManager( 3400): in removeSpuriousFiles
V/DownloadManager( 3400): starting query, database is not null; projection[0] is _data; selection is null; selectionArgs is null; sort is null.
,V/DownloadManager( 3400): created cursor android.database.sqlite.SQLiteCursor@387fcde0 on behalf of 3400
I/DownloadManager( 3400): in removeSpuriousFiles, preserving file /storage/emulated/0/.dwnld/LGMyGuide_4.40.09_COM_COM_20150430011620058_RELG-D855.apk
I/DownloadManager( 3400): in removeSpuriousFiles, preserving file /storage/emulated/0/.dwnld/LGBackup_4.50.37_COM_COM_20150608234245157.apk
I/DownloadManager( 3400): in removeSpuriousFiles, preserving file /storage/emulated/0/.dwnld/CalendarProvider_4.2.8_COM_COM_20150304234552863_RELG-D855.apk
I/DownloadManager( 3400): in removeSpuriousFiles, preserving file /storage/emulated/0/.dwnld/Calendar_4.40.16_COM_COM_20150304234554754_RELG-D855.apk
...
I/DownloadManager( 3400): in trimDatabase
V/DownloadManager( 3400): starting query, database is not null; projection[0] is _id; selection is status >= '200'; selectionArgs is null; sort is lastmod.
V/DownloadManager( 3400): created cursor android.database.sqlite.SQLiteCursor@3af1373f on behalf of 3400
V/DownloadManager( 3400): DownloadService onStartCommand
V/DownloadManager( 3400): starting query, database is not null; projection is null; selection is null; selectionArgs is null; sort is null.
V/NotificationService( 1039): enqueueNotificationInternal: pkg=com.google.android.gms id=1 notification=Notification(pri=0 contentView=null vibrate=null sound=null defaults=0x0 flags=0x10 color=0x00000000 vis=PRIVATE)
D/LGDMClient( 4339): [GCMRegisterService.java] [onHandleIntent()] : [47] : Intent : android.net.conn.CONNECTIVITY_CHANGE
...
W/Kids    ( 2333): 	at java.util.concurrent.ThreadPoolExecutor$Worker.run(ThreadPoolExecutor.java:587)
W/Kids    ( 2333): 	at java.lang.Thread.run(Thread.java:818)
V/DownloadManager( 3400): created cursor android.database.sqlite.SQLiteCursor@1143e80c on behalf of 3400
D/LgeQuickCoverNLService( 1405): onNotificationPosted
V/DownloadManager( 3400): processing inserted download 1
V/DownloadManager( 3400): processing inserted download 4
D/SmartCoverUpdateMonitor( 1405): received broadcast com.lge.intent.action.NLDataPosted
...
,V/FormManager( 7383): There are no updated forms. The schedule will be deleted.
,V/FormManager( 7383): Alarm would be updated, because LastCheckTime has been updated.
I/art     ( 2117): Explicit concurrent mark sweep GC freed 44071(2MB) AllocSpace objects, 17(2MB) LOS objects, 51% free, 30MB/62MB, paused 1.129ms total 31.547ms
,I/GLSUser ( 2117): [GLSUser] getTokenFromGoogle [account: <ELLIDED:-24588>, callingPkg: com.google.android.gms, service: ac2dm
I/GLSUser ( 2117): [GLSUser] No secrets, returning BAD_AUTH for <ELLIDED:-24588> ac2dm without consulting the cloud. [mastertoken: <EMPTY>, password: <NULL>]
,I/GLSUser ( 2117): [GLSUser] Extracting token using key: Auth
W/GLSActivity( 2117): gms.StatusHelper Status from wire: BadAuthentication status: BAD_AUTHENTICATION
...
D/QuickStatusbarLayout( 1405): Notification difference=198
D/QuickStatusbarLayout( 1405): child = android.widget.LinearLayout{1a651899 V.E..... ......ID 0,0-798,100 #7f0f0041 app:id/notification_icon_area} ,w = 798
,D/PowerManagerServiceEx( 1039): acquireWakeLockInternal: lock=444610737, flags=0x40000001, tag="*alarm*", ws=WorkSource{1000}, historyTag=*alarm*:android.intent.action.TIME_TICK, uid=1000, pid=1039
,V/QRemote ( 7264): [RemoteAppWidgetProvider.java:154:onReceive()] oooooo action name : com.lge.qremote.action.wait_loading
D/QRemote ( 7264): [RemoteAppWidgetProvider.java:211:onReceive()] oooooo 140514:alarm msg received!:1070
D/[Concierge]Service( 2601): onStartCommand(). Type : 9
,D/PowerManagerServiceEx( 1039): releaseWakeLockInternal: lock=444610737 [*alarm*], flags=0x0
,D/UEI.SmartControl( 6885): Internal timer expired: 3
...
I/chromium( 7118): 
,D/AndroidRuntime( 7597): 
D/AndroidRuntime( 7597): >>>>>> AndroidRuntime START com.android.internal.os.RuntimeInit <<<<<<
,D/AndroidRuntime( 7597): CheckJNI is OFF
V/AlarmManager( 1039): ELAPSED_WAKEUP set : Alarm{2212a012 type 2 when 289313 com.google.android.gms} when 289313
D/libc-netbsd(  312): default dns: query_ipv6=0, query_ipv4=1
...
,D/AndroidRuntime( 7597): Calling main entry com.android.commands.pm.Pm
,I/ActivityManager( 1039): Force stopping com.test.thalitest appid=10311 user=-1: uninstall pkg
I/ActivityManager( 1039): Killing 7118:com.test.thalitest/u0a311 (adj 0): stop com.test.thalitest
,W/PackageSettings( 1039): Skipping PackageSetting{36ce2929 com.example.hello/10319} due to missing metadata
,D/WifiService( 1039): Client connection lost with reason: 4
,I/WindowState( 1039): WIN DEATH: Window{1301fa8c u0 com.test.thalitest/com.test.thalitest.MainActivity}
D/InputDispatcher( 1039): Window went away: Window{1301fa8c u0 com.test.thalitest/com.test.thalitest.MainActivity}
I/ActivityManager( 1039):   Force finishing activity ActivityRecord{33689f71 u0 com.test.thalitest/.MainActivity t4}
,E/GBMv2   (  331): DFP En is all cleared set to be enabled
,W/ActivityManager( 1039): Spurious death for ProcessRecord{e9fd3e3 7118:com.test.thalitest/u0a311}, curProc for 7118: null
I/ActivityManager( 1039): Force stopping com.test.thalitest appid=10311 user=0: pkg removed
I/ActivityManager( 1039):   Force finishing activity ActivityRecord{33689f71 u0 com.test.thalitest/.MainActivity t4 f}
W/ActivityManager( 1039): Duplicate finish request for ActivityRecord{33689f71 u0 com.test.thalitest/.MainActivity t4 f}
,D/SplitWindowPolicy( 1958): updateActivityStateChanged: resumed=false, screenId=0, isScreenFull=false
D/SplitWindowPolicy( 1958): topRunningActivity=ActivityInfo{2dff7421 co.....Launcher}, taskId=3, activityType=1, bIsSplit=false
,D/SplitWindowPolicy( 1958): updateActivityStateChanged: resumed=true, screenId=0, isScreenFull=false
D/SplitWindowPolicy( 1958): topRunningActivity=ActivityInfo{1dacb046 co.....Launcher}, taskId=3, activityType=1, bIsSplit=false
...
D/PostponalbeReceiver( 6666): WSAndroidSystemIntentReceiver is processing the broadcast action 'android.intent.action.PACKAGE_REMOVED'.
I/art     ( 4562): Explicit concurrent mark sweep GC freed 16402(926KB) AllocSpace objects, 0(0B) LOS objects, 34% free, 30MB/46MB, paused 335us total 79.756ms
...
,I/ActivityManager( 1039): Start proc com.lge.lockscreensettings for content provider com.lge.lockscreensettings/.LockSettingsProvider: pid=7624 uid=10080 gids={50080, 9997, 1028, 1015} abi=armeabi-v7a
...
I/[SystemUI]AppWidgetPanel(QRemoteWidgetPanel)( 1465): onReceive = android.intent.action.PACKAGE_REMOVED, packageName : com.test.thalitest
,I/art     ( 1039): Explicit concurrent mark sweep GC freed 68056(3MB) AllocSpace objects, 6(480KB) LOS objects, 33% free, 44MB/66MB, paused 3.313ms total 154.275ms
...
I/GBoardWebViewUtils( 2077): , display: false
I/GBoardWebViewUtils( 2077): , animation: false }
I/GBoardWebViewUtils( 2077): checkExpiredAndRemoveCard() card: GBoardCard = { id: guide_1111111111116_1452175674810
I/GBoardWebViewUtils( 2077): , create_time: 1452175675684
I/GBoardWebViewUtils( 2077): , expire_time: 0
I/GBoardWebViewUtils( 2077): , raw_uri: file:///system/etc/mrg_default_forms/MyGuide/GBoard/UserGuideCard/1/userguide.html?id=guide_1111111111116_1452175674810&desc=[@string/gboard_ugc_desc_single]&appname=[@string/sp_smart_tips_text]&display_type=overlay
I/GBoardWebViewUtils( 2077): , category: com.lge.intent.category.gboard.DOYOUKNOW
I/GBoardWebViewUtils( 2077): , display: false
I/GBoardWebViewUtils( 2077): , animation: false }
...
,I/LockScreenSettings( 7624): Wallpaper base directory = /data/user/0/com.lge.lockscreensettings/files/
...
I/[SystemUI]NavigationThemeResource( 1465): , Keyguard show=false, IME shown=false, Panel expanded=false
I/art     ( 1039): Explicit concurrent mark sweep GC freed 8697(514KB) AllocSpace objects, 0(0B) LOS objects, 33% free, 44MB/66MB, paused 9.118ms total 179.080ms
I/art     ( 1039): WaitForGcToComplete blocked for 157.624ms for cause Explicit
...
D/AppUp4:PreloadHelper( 7357): added Exclude : com.test.thalitest
...
I/[LGHome]Launcher( 2077): [Launcher.java:4127:setLoadOnResume()]setLoadOnResume
I/ActivityManager( 1039): Start proc com.android.contacts for broadcast com.android.contacts/.quickcontact.PackageIntentReceiver: pid=7648 uid=10019 gids={50019, 9997, 3003, 1028, 1015, 1023, 4002} abi=armeabi-v7a
I/Timeline( 1039): Timeline: Activity_windows_visible id: ActivityRecord{1b1bcf88 u0 com.lge.launcher2/.Launcher t3} time:290144
I/[Concierge]WidgetView( 2077): ConciergeWidgetView is instantiated. sIsWidgetAttached : true
,I/ActivityManager( 1039): Killing 6972:com.google.android.gms.wearable/u0a5 (adj 15): empty #17
,I/art     ( 1039): Explicit concurrent mark sweep GC freed 3809(228KB) AllocSpace objects, 0(0B) LOS objects, 33% free, 44MB/66MB, paused 2.364ms total 121.625ms
...
W/libprocessgroup( 1039): failed to open /acct/uid_10005/pid_6972/cgroup.procs: No such file or directory
...
D/KeyguardModel( 1465): package = com.lge.camera, class = com.lge.camera.CameraApp
D/KeyguardModel( 1465): createShortcutInfo...
I/[Concierge]WidgetView( 2077): initWebView(). Time : 1452688881736
D/[Concierge]Service( 2601): onStartCommand(). Type : 0
D/KeyguardModel( 1465): handleShortcutListChanged...
W/ResourcesManager( 7648): Asset path '/system/framework/com.google.android.maps.jar' does not exist or contains no resources.
W/ResourcesManager( 7648): Asset path '/system/framework/com.lge.mdm.jar' does not exist or contains no resources.
W/ResourcesManager( 7648): Asset path '/system/framework/com.lge.telephony.sms.jar' does not exist or contains no resources.
W/ResourcesManager( 7648): Asset path '/system/framework/lghiddenlibs.jar' does not exist or contains no resources.
W/ResourcesManager( 7648): Asset path '/system/framework/qcrilhook.jar' does not exist or contains no resources.
,I/[Concierge]WebView( 2077): Return exist ConciergeWebView. Reuse : 154710801
...
I/[LgeWidgetLib]ExtViewHost( 2077): [LgeAppWidgetExtViewHost.java:136:setState()]New State = com.lge.lgewidgetlib.extview.NormalState@33ac51e6
...
W/[Concierge]WidgetView( 2077): Widget kill message received. Destory myself. My : 1452688618705, New one : 1452688881736
...
,I/SystemConfig( 7648): BUILD Country: EU
I/SystemConfig( 7648): BUILD Operator: OPEN
I/[LgeWidgetLib]LgeAppWidgetHostView( 2077): [LgeAppWidgetHostView.java:121:initExtManager()]mExtViewHost created
,I/ActivityManager( 1039): Killing 6476:com.google.android.apps.books/u0a54 (adj 15): empty #17
...
,I/[LGHome]Launcher( 2077): [Launcher.java:4127:setLoadOnResume()]setLoadOnResume
I/Timeline( 2077): Timeline: Activity_idle id: android.os.BinderProxy@1b0b931a time:290376
,W/libprocessgroup( 1039): failed to open /acct/uid_10054/pid_6476/cgroup.procs: No such file or directory
,I/SystemConfig( 7648): pm.hasSystemFeature(com.lge.ims.rcs) = false
I/SystemConfig( 7648): existFile = false
I/SystemConfig( 7648): canReadFile = false
I/SystemConfig( 7648): systemFeature RCS result false
D/SystemConfig( 7648): refreshRcsSupport() :false
I/PackageChangeReceiver( 6721): intent action : android.intent.action.PACKAGE_REMOVED (at PackageChangeReceiver.java onReceive 20)
D/VoicemailCleanupService( 2178): Cleaning up data for package: com.test.thalitest
,I/ActivityManager( 1039): Start proc com.android.gallery3d for broadcast com.android.gallery3d/.app.PackagesMonitor: pid=7668 uid=10027 gids={50027, 9997, 3003, 1028, 1015, 1023, 4002, 4003} abi=armeabi-v7a
...
W/ResourcesManager( 7668): Asset path '/system/framework/com.lge.divx.jar' does not exist or contains no resources.
W/ResourcesManager( 7668): Asset path '/system/framework/com.lge.zdi.splitwindow.jar' does not exist or contains no resources.
...
V/BoardContentProvider( 3747): query(): uri(content://com.lge.mrg.boardcontent/gboard) projection(null) order(null)
V/BoardContentProvider( 3747): query(): uri(content://com.lge.mrg.boardcontent/gboard) projection(null) order(null)
,I/AppConfig( 7668): Total System Memory = 2995761152
D/SystemHelper( 7668): region [EU], country [EU], operator [OPEN], sub-operator []
...
D/GBoardUriUtils( 2077): fileExists: file:///system/etc/mrg_default_forms/MyGuide/GBoard/UserGuideCard/1/userguide2.html?id=guide_1111111111116_1452175674810&desc=[@string/gboard_ugc_desc_single]&appname=[@string/sp_smart_tips_text]&display_type=overlay return true
D/GBoardWebViewUtils( 2077): changeCardUriByCategoryNum() chard uri is changed. return: file:///system/etc/mrg_default_forms/MyGuide/GBoard/UserGuideCard/1/userguide2.html?id=guide_1111111111116_1452175674810&desc=[@string/gboard_ugc_desc_single]&appname=[@string/sp_smart_tips_text]&display_type=overlay
...
,D/PostponalbeReceiver( 6666): OasPackageInstalledReceiver is processing the broadcast action 'android.intent.action.PACKAGE_REMOVED'.
I/ActivityManager( 1039): Start proc com.lge.lifetracker for broadcast com.lge.lifetracker/.core.receiver.CoreEventReceiver: pid=7693 uid=10037 gids={50037, 9997, 3003, 3002, 3001, 1028, 1015} abi=armeabi-v7a
,E/GBMv2   (  331): DFP En is all cleared set to be enabled
E/GBMv2   (  331): Set value is all cleared set the max
I/GBMv2   (  331): DFP Enabled. Ignore VFP set
