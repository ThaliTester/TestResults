#### Test 5497026186051be_thali03_LGE-LG-D855 Logs


```
--------- beginning of main
D/Finsky  ( 6252): [1] 5.onFinished: Giving up after 6 failures.
...
D/ActivityManager( 1040): setTaskToReturnTo : TaskRecord{cadde1c #4 A=com.test.thalitest U=0 sz=0} / mTaskToReturnTo = 1
D/ActivityManager( 1040): setTaskToReturnTo : TaskRecord{cadde1c #4 A=com.test.thalitest U=0 sz=0} / mTaskToReturnTo = 1
D/WindowStateEx( 1040): AppWindowTokenEx init.. 
E/GBMv2   (  336): DFP En is all cleared set to be enabled
I/ActivityManager( 1040): Start proc com.test.thalitest for activity com.test.thalitest/.MainActivity: pid=7196 uid=10311 gids={50311, 9997, 3003, 3001, 3002, 1028, 1015} abi=armeabi-v7a
...
D/SplitWindowPolicy( 1970): topRunningActivity=ActivityInfo{3df0bd0b co.....MainActivity}, taskId=4, activityType=0, bIsSplit=false
D/SplitWindowPolicy( 1970): updateActivityStateChanged: resumed=false, screenId=1, isScreenFull=true
D/SplitWindowPolicy( 1970): topRunningActivity=ActivityInfo{3a9c07e8 co.....MainActivity}, taskId=4, activityType=0, bIsSplit=false
...
I/LibraryLoader( 7196): Time to load native libraries: 5 ms (timestamps 5799-5804)
I/LibraryLoader( 7196): Expected native library version number "",actual native library version number ""
V/WebViewChromiumFactoryProvider( 7196): Binding Chromium to main looper Looper (main, tid 1) {1d2aff7b}
I/LibraryLoader( 7196): Expected native library version number "",actual native library version number ""
...
V/AudioPolicyService(  316): registerClient() client 0xb558a3c0, uid 10311
...
D/BluetoothManagerService( 1040): Added callback: android.bluetooth.IBluetoothManagerCallback$Stub$Proxy@21c7a9c6:true
...
W/art     ( 7196): Attempt to remove local handle scope entry from IRT, ignoring
W/art     ( 7196): Attempt to remove local handle scope entry from IRT, ignoring
W/ActivityManager( 1040): Activity pause timeout for ActivityRecord{55c4a25 u0 com.test.thalitest/.MainActivity t4}
...
D/SplitWindow( 1040): check instance of lgWin Window{2e433950 u0 com.test.thalitest/com.test.thalitest.MainActivity}
...
I/SystemUI[Framework]( 1040): ==>disabledNaviBtn() what=0x0, token=android.os.Binder@7fba31c,  pkg=WindowManager.LayoutParams
I/SystemUI[Framework]( 1040): disableNaviBtn: mDisabledNaviBtn=0x0,  mDisableRecords.size=0
I/ActivityManager( 1040): Displayed com.test.thalitest/.MainActivity: +683ms (total +778ms)
I/Timeline( 7196): Timeline: Activity_idle id: android.os.BinderProxy@b76bd6b time:286282
I/Timeline( 1040): Timeline: Activity_windows_visible id: ActivityRecord{55c4a25 u0 com.test.thalitest/.MainActivity t4} time:286284
...
I/chromium( 7196): 
D/jxcore_app_log( 7196): JniHelper::setJavaVM(0xb487c280), pthread_self() = -1435060992
...
W/.test.thalitest( 7196): type=1400 audit(0.0:164): avc: denied { ioctl } for path="socket:[7574]" dev="sockfs" ino=7574 scontext=u:r:untrusted_app:s0 tcontext=u:r:zygote:s0 tclass=unix_dgram_socket
W/.test.thalitest( 7196): type=1400 audit(0.0:165): avc: denied { ioctl } for path="/sys/kernel/debug/tracing/trace_marker" dev="debugfs" ino=3222 scontext=u:r:untrusted_app:s0 tcontext=u:object_r:debugfs:s0 tclass=file
W/.test.thalitest( 7196): type=1400 audit(0.0:166): avc: denied { ioctl } for path="socket:[9838]" dev="sockfs" ino=9838 scontext=u:r:untrusted_app:s0 tcontext=u:r:zygote:s0 tclass=unix_dgram_socket
W/.test.thalitest( 7196): type=1400 audit(0.0:167): avc: denied { ioctl } for path="/cust" dev="mmcblk0p42" ino=2 scontext=u:r:untrusted_app:s0 tcontext=u:object_r:cust_data_file:s0 tclass=dir
W/.test.thalitest( 7196): type=1400 audit(0.0:168): avc: denied { ioctl } for path="socket:[32375]" dev="sockfs" ino=32375 scontext=u:r:untrusted_app:s0 tcontext=u:r:surfaceflinger:s0 tclass=unix_stream_socket
,I/art     ( 7196): Background sticky concurrent mark sweep GC freed 124657(12MB) AllocSpace objects, 23(7MB) LOS objects, 28% free, 39MB/55MB, paused 1.881ms total 135.312ms
...
D/WifiServiceImplEx( 1040): setWifiEnabled: true pid=7196, uid=10311, package= com.test.thalitest, App Lable : ThaliTest
,D/WifiService( 1040): setWifiEnabled: true pid=7196, uid=10311
E/WifiService( 1040): Invoking mWifiStateMachine.setWifiEnabled
D/WifiServiceImplEx( 1040): disconnect pid=7196, uid=10311, packageName=com.test.thalitest
E/WifiStateMachine( 1040):  ConnectedState CMD_DISCONNECT 0 0
E/WifiStateMachine( 1040):  L2ConnectedState CMD_DISCONNECT 0 0
D/WifiServiceImplEx( 1040): reconnect pid=7196, uid=10311, packageName=com.test.thalitest
I/jxcore-log( 7196): Radios toggled
I/jxcore-log( 7196): 
E/WifiNative: ( 1040): [288,695,895 us] DISCONNECT  stack:logDbg - disconnect - processMessage - processMsg - handleMessage
D/WifiNative-wlan0( 1040): doBoolean: DISCONNECT
I/jxcore-log( 7196): My device name is: LGE-LG-D855
I/jxcore-log( 7196): 
,I/wpa_supplicant( 2670): wlan0: CTRL-EVENT-DISCONNECTED bssid=c0:ff:d4:d3:aa:48 reason=3 locally_generated=1,
...
I/wpa_supplicant( 2670): wpa_driver_nl80211_ext_driver_cmd BTCOEXMODE 2
...
,D/DhcpStateMachine( 1040): RunningState{ when=-6ms what=196610 target=com.android.internal.util.StateMachine$SmHandler }
,V/NativeCrypto( 2137): Read error: ssl=0xaf499600: I/O error during system call, Connection timed out
V/NativeCrypto( 2137): SSL shutdown failed: ssl=0xaf499600: I/O error during system call, Broken pipe
D/ConnectivityService( 1040): reportBadNetwork(NetworkAgentInfo [WIFI () - 100]) by 10005
D/NetworkMonitor NetworkAgentInfo [WIFI () - null]( 1040): ValidatedState{ when=-5ms what=532488 arg1=10005 target=com.android.internal.util.StateMachine$SmHandler }
D/NetworkMonitor NetworkAgentInfo [WIFI () - null]( 1040): DefaultState{ when=-5ms what=532488 arg1=10005 target=com.android.internal.util.StateMachine$SmHandler }
...
I/ActivityManager( 1040): Start proc com.android.settings for broadcast com.android.settings/.deviceinfo.UsbSettingsReceiver: pid=7283 uid=1000 gids={41000, 9997, 1000, 1028, 1015, 2001, 3002, 3001, 1007, 3003, 1023, 1021, 3004, 3005, 3009, 1010, 1004, 2002, 3008, 1026, 1009, 1027, 1003, 1014, 4002, 1002} abi=armeabi-v7a
...
E/WifiNative: ( 1040): [288,864,176 us] RECONNECT  stack:logDbg - reconnect - processMessage - processMsg - handleMessage
D/WifiNative-wlan0( 1040): doBoolean: RECONNECT
I/wpa_supplicant( 2670): wlan0: CTRL-EVENT-SCAN-STARTED 
...
E/WifiStateMachine( 1040):  DisconnectingState CMD_TETHER_STATE_CHANGE 0 0
...
E/WifiStateMachine( 1040):  DisconnectingState NETWORK_DISCONNECTION_EVENT c0:ff:d4:d3:aa:48 nid=1 reason=3 rt=288874
E/WifiStateMachine( 1040):  ConnectModeState NETWORK_DISCONNECTION_EVENT c0:ff:d4:d3:aa:48 nid=1 reason=3 rt=288874
D/LGWifiP2pService( 1040): InactiveState{ when=-1ms what=143375 target=com.android.internal.util.StateMachine$SmHandler }
D/LGWifiP2pService( 1040): P2pEnabledState{ when=-1ms what=143375 target=com.android.internal.util.StateMachine$SmHandler }
D/WifiNative-wlan0( 1040): doBoolean: DRIVER BTCOEXMODE 2
I/wpa_supplicant( 2670): wpa_driver_nl80211_ext_driver_cmd BTCOEXMODE 2
...
D/WifiOffDelayIfNotUsed( 1040): NETWORK_STATE_CHANGED_ACTION [DISCONNECTED]
D/StatusBar.NetworkController( 1462): refreshViews: Data not connected!! Set no data type icon / Roaming
E/WifiStateMachine( 1040):  DisconnectedState SUPPLICANT_STATE_CHANGE_EVENT 21 0 rt=288895  SSID: NG700 BSSID: c0:ff:d4:d3:aa:48 nid: 0 state: DISCONNECTED
E/WifiStateMachine( 1040):  ConnectModeState SUPPLICANT_STATE_CHANGE_EVENT 21 0 rt=288895  SSID: NG700 BSSID: c0:ff:d4:d3:aa:48 nid: 0 state: DISCONNECTED
...
E/WifiStateMachine( 1040):  SupplicantStartedState CMD_UPDATE_LINKPROPERTIES 0 0
E/WifiStateMachine( 1040):  DefaultState CMD_UPDATE_LINKPROPERTIES 0 0
E/WifiStateMachine( 1040):  DisconnectedState SUPPLICANT_STATE_CHANGE_EVENT 22 0 rt=288899  SSID:  BSSID: 00:00:00:00:00:00 nid: -1 state: SCANNING
...
D/TelephonyNetworkFactory-1( 1873): new score 0 for exisiting request NetworkRequest [ id=1, legacyType=-1, [ Capabilities: INTERNET&NOT_RESTRICTED&TR,USTED&NOT_VPN] ]
...
E/WifiStateMachine( 1040):  ConnectModeState SUPPLICANT_STATE_CHANGE_EVENT 22 0 rt=288912  SSID:  BSSID: 00:00:00:00:00:00 nid: -1 state: SCANNING
...
W/ResourcesManager( 7283): Asset path '/system/framework/cneapiclient.jar' does not exist or contains no resources.
W/ResourcesManager( 7283): Asset path '/system/framework/com.lge.mdm.jar' does not exist or contains no resources.
W/ResourcesManager( 7283): Asset path '/system/framework/com.lge.bluetooth.jar' does not exist or contains no resources.
W/ResourcesManager( 7283): Asset path '/system/framework/qcrilhook.jar' does not exist or contains no resources.
D/TelephonyIcons( 1462): null signal icon name: drawable/stat_sys_signal_null
W/ResourcesManager( 7283): Asset path '/system/framework/com.broadcom.bt.jar' does not exist or contains no resources.
,D/StatusBar.NetworkController( 1462): refreshViews: Data not connected!! Set no data type icon / Roaming
D/StatusBar.NetworkController( 1462): refreshViews: Data not connected!! Set no data type icon / Roaming
D/TelephonyIcons( 1462): null signal icon name: drawable/stat_sys_signal_null
D/StatusBar.NetworkController( 1462): refreshViews: Data not connected!! Set no data type icon / Roaming
...
D/DhcpStateMachine( 1040): StoppedState{ when=-111ms what=196610 target=com.android.internal.util.StateMachine$SmHandler }
,D/UsbSettingsReceiver( 7283): [AUTORUN] onReceive() : action = android.net.conn.TETHER_STATE_CHANGED
D/UsbSettingsReceiver( 7283): [AUTORUN] sys.usb.config = ptp_only,adb
D/UsbSettingsReceiver( 7283): [AUTORUN] sys.usb.state = ptp_only,adb
D/UsbSettingsReceiver( 7283): [AUTORUN] persist.sys.usb.config = ptp_only,adb
D/UsbSettingsReceiver( 7283): [AUTORUN] onReceive() : app userid = 0, current userid = 0
,D/UsbSettingsControl( 7283): [AUTORUN] getUsbConnected() : connected=true
D/UsbSettingsReceiver( 7283): [AUTORUN] onReceive() : availableList=[]
D/UsbSettingsReceiver( 7283): [AUTORUN] onReceive() : activeList=[]
D/UsbSettingsReceiver( 7283): [AUTORUN] onReceive() : errorList=[]
D/UsbSettingsControl( 7283): [AUTORUN] isAutorunTimer() : mAutorunChanging=false
D/UsbSettingsControl( 7283): [AUTORUN] setTetherStatus() : status=false
...
,I/ActivityManager( 1040): Start proc com.lge.sync for broadcast com.lge.sync/.StartReceiver: pid=7320 uid=1000 gids={41000, 9997, 1000, 1028, 1015, 2001, 3002, 3001, 1007, 3003, 1023, 1021, 3004, 3005, 3009, 1010, 1004, 2002, 3008, 1026, 1009, 1027, 1003, 1014, 4002, 1002} abi=armeabi-v7a
,I/ActivityManager( 1040): Killing 6720:com.google.android.partnersetup/u0a8 (adj 15): empty #17
I/art     (  340): Explicit concurrent mark sweep GC freed 709(30KB) AllocSpace objects, 0(0B) LOS objects, 54% free, 26MB/58MB, paused 452us total 19.883ms
,I/art     (  340): Explicit concurrent mark sweep GC freed 5(160B) AllocSpace objects, 0(0B) LOS objects, 54% free, 26MB/58MB, paused 404us total 19.646ms
,I/art     (  340): Explicit concurrent mark sweep GC freed 5(160B) AllocSpace objects, 0(0B) LOS objects, 54% free, 26MB/58MB, paused 356us total 18.005ms
,W/libprocessgroup( 1040): failed to open /acct/uid_10008/pid_6720/cgroup.procs: No such file or directory
,I/PCSuite ( 7320): [StartReceiver]NETWORK_STATE_CHANGED_ACTION : DISCONNECTED/IDLE
,D/PCSuite ( 7320): [StartReceiver][getUpdateNecessity]update = false
D/PCSuite ( 7320): [StartReceiver][LGSW]false, [WIFIUI]false, [WIFI]false, [HOTSPOT]false, [OBEXSERVICE]false
V/WiFiOffLoadBroadcast( 7283): WiFiOffLoadBroadcast: android.net.wifi.STATE_CHANGE
,D/LgDataFeature( 7283): LgDataFeature() Constructor: none
D/LgDataFeature( 7283): LgDataFeature() Constructor Done, null
,D/WiFiOffLoadBroadcast( 7283): MCCMNC not supported: null
,I/ActivityManager( 1040): Start proc com.lge.qremote for broadcast com.lge.qremote/.settings.WiFiStateReceiver: pid=7341 uid=10112 gids={50112, 9997, 1028, 1015, 3003, 3002} abi=armeabi
,I/ActivityManager( 1040): Killing 6145:com.lge.appbox.client/u0a11 (adj 15): empty #17
W/libprocessgroup( 1040): failed to open /acct/uid_10011/pid_6145/cgroup.procs: No such file or directory
,W/ResourcesManager( 7341): Asset path '/system/framework/com.lge.mdm.jar' does not exist or contains no resources.
,D/QRemote ( 7341): [QRemoteApplication.java:230:onCreate()] oooooo QRemoteApp onCreate....
,D/QRemote ( 7341): [CarrierUtils.java:858:getHardwareSettings()] oooooo qremote android.os.Build.MODEL = LG-D855
I/QRemote ( 7341): [CarrierUtils.java:859:getHardwareSettings()] oooooo getCountry :: EU
,I/QRemote ( 7341): [CarrierUtils.java:860:getHardwareSettings()] oooooo getCarrier :: OPEN
I/QRemote ( 7341): [CarrierUtils.java:861:getHardwareSettings()] oooooo getArea :: COM
D/QRemote ( 7341): [CarrierUtils.java:862:getHardwareSettings()] oooooo Loading Config...
D/QRemote ( 7341): [CarrierUtils.java:876:getHardwareSettings()] oooooo qremote configuration file = R.xml.qremote_conf
D/QRemote ( 7341): [QRemoteApplication.java:701:updateWidget()] oooooo Widget count is [1]. send broadcast
D/QRemote ( 7341): [WiFiStateReceiver.java:50:onReceive()] oooooo 140626:action:android.net.wifi.STATE_CHANGE
D/QRemote ( 7341): [WiFiStateReceiver.java:118:onReceive()] oooooo NETWORK_STATE_CHANGED_ACTION
,I/QRemote ( 7341): [WiFiStateReceiver.java:199:onReceive()] oooooo The network is disconnected.
,D/PostponalbeReceiver( 6692): WSAndroidSystemIntentReceiver is processing the broadcast action 'android.net.wifi.STATE_CHANGE'.
D/QRemote ( 7341): [QRemoteService.java:196:onCreate()] oooooo 140526:onCreate
I/PCSuite ( 7320): [StartReceiver]NETWORK_STATE_CHANGED_ACTION : DISCONNECTED/IDLE
D/PCSuite ( 7320): [StartReceiver][getUpdateNecessity]update = false
D/PCSuite ( 7320): [StartReceiver][LGSW]false, [WIFIUI]false, [WIFI]false, [HOTSPOT]false, [OBEXSERVICE]false
D/QRemote ( 7341): [QRemoteService.java:217:onStartCommand()] oooooo 140526:onStartCommand:action:action.application.oncreate. startId:1, flags:0
V/WiFiOffLoadBroadcast( 7283): WiFiOffLoadBroadcast: android.net.wifi.STATE_CHANGE
,D/WiFiOffLoadBroadcast( 7283): MCCMNC not supported: null
D/QRemote ( 7341): [WiFiStateReceiver.java:50:onReceive()] oooooo 140626:action:android.net.wifi.STATE_CHANGE
D/QRemote ( 7341): [WiFiStateReceiver.java:118:onReceive()] oooooo NETWORK_STATE_CHANGED_ACTION
...
D/QRemote ( 7341): [WiFiStateReceiver.java:118:onReceive()] oooooo NETWORK_STATE_CHANGED_ACTION
I/QRemote ( 7341): [WiFiStateReceiver.java:199:onReceive()] oooooo The network is disconnected.
V/QRemote ( 7341): [RemoteAppWidgetProvider.java:154:onReceive()] oooooo action name : android.appwidget.action.APPWIDGET_UPDATE
,D/QRemote ( 7341): [RemoteAppWidgetProvider.java:449:onUpdate()] oooooo onUpdate()
D/QRemote ( 7341): [QRemoteApplication.java:86:getControlManager()] oooooo mControlManager is null. make new RemoteControlManager
D/DSQN    ( 1040): EVENT_INTERNET_CHECK_ENABLE received
D/LgDataFeature( 7341): LgDataFeature() Constructor: none
D/LgDataFeature( 7341): LgDataFeature() Constructor Done, null
,V/SoundPool( 7341): SoundPool constructor: maxChannels=2, attr.usage=13, attr.flags=0x0, attr.tags=
V/SoundPool( 7341): load: fd=30, offset=10857164, length=17813, priority=1
V/SoundPool( 7341): create sampleID=1, fd=31, offset=17813 length=10857164
V/SoundPool( 7341): doLoad: loading sample sampleID=1
I/QRemote ( 7341): [RemoteControlManager.java:157:onBindIRService()] oooooo bind
V/SoundPool( 7341): Start decode
V/MediaPlayer[Native]( 7341): decode(31, 10857164, 17813)
...
V/AwesomePlayer(  316): reset_l() 
V/AudioCache(  316): notify(0xb1432c80, 8, 0, 0)
...
D/UEI.SmartControl( 6878): QS Service created
,D/QRemote ( 7341): [RemoteControlManager.java:441:setStateInt()] oooooo RemoteControl set [State]11
E/QRemote ( 7341): [RemoteAppWidgetProvider.java:406:isLimitationView()] oooooo rotation : 0
D/QRemote ( 7341): [RemoteAppWidgetProvider.java:457:onUpdate()] oooooo onUpdate orientation:true
V/LGMDMManager( 7341): Create singleton instance
I/UEI.SmartControl( 6878): Service initServices...
,D/UEI.SmartControl( 6878): QS start get config
...
V/OMXCodec(  316): [OMX.google.vorbis.decoder] allocated buffer 0xb54f7830 on input port
V/OMXCodec(  316): [OMX.google.vorbis.decoder] allocated buffer 0xb54f78d0 on input port
V/OMXCodec(  316): [OMX.google.vorbis.decoder] allocated buffer 0xb54f79c0 on input port
V/OMXCodec(  316): [OMX.google.vorbis.decoder] allocated buffer 0xb54f7c90 on input port
...
V/OMXCodec(  316): [OMX.google.vorbis.decoder] allocated buffer 0xb54f7e20 on output port
V/OMXCodec(  316): [OMX.google.vorbis.decoder] allocated buffer 0xb54f7ec0 on output port
V/OMXCodec(  316): [OMX.google.vorbis.decoder] allocated buffer 0xb57bf1a0 on output port
V/OMXCod,ec(  316): [OMX.google.vorbis.decoder] allocated buffer 0xb57bf3d0 on output port
...
V/AudioCache(  316): notify(0xb1432c80, 5, 0, 0)
V/AudioCache(  316): ignored
V/AudioCache(  316): notify(0xb1432c80, 1, 0, 0)
...
V/OMXCodec(  316): [OMX.google.vorbis.decoder] Port is disabled, freeing buffer 3041885728
V/OMXCodec(  316): [OMX.google.vorbis.decoder] freeBuffer portIndex=1,bufIndex=0
V/OMXCodec(  316): [OMX.google.vorbis.decoder] Port is disabled, freeing buffer 3041885888
V/OMXCodec(  316): [OMX.google.vorbis.decoder] freeBuffer portIndex=1,bufIndex=0
V/OMXCodec(  316): [OMX.google.vorbis.decoder] Port is disabled, freeing buffer 3044798880
V/OMXCodec(  316): [OMX.google.vorbis.decoder] freeBuffer portIndex=1,bufIndex=0
V/OMXCodec(  316): [OMX.google.vorbis.decoder] Port is disabled, freeing buffer 3044799440
V/OMXCodec(  316): [OMX.google.vorbis.decoder] freeBuffer portIndex=1,bufIndex=0
...
V/OMXCodec(  316): [OMX.google.vorbis.decoder] allocated buffer 0xb54f7ec0 on output port
V/OMXCodec(  316): [OMX.google.vorbis.decoder] allocated buffer 0xb54f7e20 on output port
V/OMXCodec(  316): [OMX.google.vorbis.decoder] allocated buffer 0xb57bf600 on output port
...
V/AudioCache(  316): notify(0xb1432c80, 6, 0, 0)
V/AudioCache(  316): ignored
V/MediaPlayerService(  316): wait for playback complete
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab700000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab701000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab702000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab703000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab704000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab705000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab706000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab707000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab708000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab709000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab70a000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab70b000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab70c000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab70d000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab70e000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab70f000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab710000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab711000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab712000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab713000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab714000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab715000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab716000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
,V/AudioCache(  316): memcpy(0xab717000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab718000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab719000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab71a000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab71b000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab71c000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab71d000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab71e000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab71f000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab720000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab721000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab722000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab723000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab724000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab725000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab726000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab727000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab728000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab729000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab72a000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab72b000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab72c000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab72d000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab72e000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab72f000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab730000, 0xb1661000, 4096)
V/AudioCache(  316): write(0xb1661000, 4096)
V/AudioCache(  316): memcpy(0xab731000, 0xb1661000, 4096)
...
V/AudioCache(  316): write(0xb1661000, 280)
V/AudioCache(  316): memcpy(0xab732000, 0xb1661000, 280)
...
V/AudioCache(  316): notify(0xb1432c80, 2, 0, 0)
V/AudioCache(  316): playback complete
V/AwesomePlayer(  316): pause_l() 
V/AudioCache(  316): notify(0xb1432c80, 7, 0, 0)
V/AudioCache(  316): ignored
V/AwesomePlayer(  316): cancelPlayerEvents
...
V/OMXCodec(  316): [OMX.google.vorbis.decoder] freeing buffer 0xb54f7c90 on port 0
V/OMXCodec(  316): [OMX.google.vorbis.decoder] freeBuffer portIndex=0,bufIndex=3
V/OMXCodec(  316): [OMX.google.vorbis.decoder] freeing buffer 0xb54f79c0 on port 0
V/OMXCodec(  316): [OMX.google.vorbis.decoder] freeBuffer portIndex=0,bufIndex=2
V/OMXCodec(  316): [OMX.google.vorbis.decoder] freeing buffer 0xb54f78d0 on port 0
V/OMXCodec(  316): [OMX.google.vorbis.decoder] freeBuffer portIndex=0,bufIndex=1
V/OMXCodec(  316): [OMX.google.vorbis.decoder] freeing buffer 0xb54f7830 on port 0
V/OMXCodec(  316): [OMX.google.vorbis.decoder] freeBuffer portIndex=0,bufIndex=0
V/OMXCodec(  316): [OMX.google.vorbis.decoder] freeBuffersOnPort portIndex=1
V/OMXCodec(  316): [OMX.google.vorbis.decoder] freeing buffer 0xb57bf600 on port 1
V/OMXCodec(  316): [OMX.google.vorbis.decoder] freeBuffer portIndex=1,bufIndex=3
V/OMXCodec(  316): [OMX.google.vorbis.decoder] freeing buffer 0xb54f7e20 on port 1
V/OMXCodec(  316): [OMX.google.vorbis.decoder] freeBuffer portIndex=1,bufIndex=2
V/OMXCodec(  316): [OMX.google.vorbis.decoder] freeing buffer 0xb54f7ec0 on port 1
V/OMXCodec(  316): [OMX.google.vorbis.decoder] freeBuffer portIndex=1,bufIndex=1
V/OMXCodec(  316): [OMX.google.vorbis.decoder] freeing buffer 0xb57bf1a0 on port 1
V/OMXCodec(  316): [OMX.google.vorbis.decoder] freeBuffer portIndex=1,bufIndex=0
...
V/AwesomePlayer(  316): reset_l() 
V/AwesomePlayer(  316): cancelPlayerEvents
V/SoundPool( 7341): close(31)
V/SoundPool( 7341): pointer = 0x9ff2d000, size = 205080, sampleRate = 48000, numChannels = 2
D/QRemote ( 7341): [RemoteAppWidgetProvider.java:480:onUpdate()] oooooo updateAppWidget to loading view
D/QRemote ( 7341): [RemoteAppWidgetProvider.java:486:onUpdate()] oooooo 140510:RetrieveDevices is not complete. Just waiting
D/QRemote ( 7341): [RemoteAppWidgetProvider.java:499:onUpdate()] oooooo 140514:alarm set after 5000ms:2081
I/UEI.SmartControl( 6878): Supports setup maps: true
D/UEI.SmartControl( 6878): QS start statue = true Error code = 0
I/UEI.SmartControl( 6878): QS version = v2.7.10.1_RC1
I/UEI.SmartControl( 6878): QS DB version: LG_Optimus_G2_Phone_Korea_database_v3.14_nevosmart
I/UEI.SmartControl( 6878): ### init IR Blaster...
D/serial_port( 6878): Configuring serial port
E/UEI.SmartControl( 6878): UEIBLaster setting for 616
I/UEI.SmartControl( 6878): Setting serial record hearder size = 2
I/UEI.SmartControl( 6878): configuring settings for MAXQ616
I/UEI.SmartControl( 6878): Get version...
,D/UEI.SmartControl( 6878): serial port data available: 21,
,D/UEI.SmartControl( 6878): MAXQ616 A2-X4 software.
,I/UEI.SmartControl( 6878): IR Blaster version: 256702256704300002
I/UEI.SmartControl( 6878): QS saving settings...
D/UEI.SmartControl( 6878): IR Blaster version: 25672567
,D/UEI.SmartControl( 6878): serial port data available: 4
,W/ContextImpl( 6878): Calling a method in the system process without a qualified user: android.app.ContextImpl.bindService:1821 android.content.ContextWrapper.bindService:538 com.uei.control.Service.b:-1 com.uei.control.Service.a:-1 com.uei.control.Service.onCreate:-1 
I/UEI.SmartControl( 6878): Device manager: loading config....
D/UEI.SmartControl( 6878): ----------- loading internal config...
,E/UEI.SmartControl( 6878): Services init done
D/UEI.SmartControl( 6878): QS Service init finished
D/UEI.SmartControl( 6878): QS Service version name: 2.1.91
D/UEI.SmartControl( 6878): QS Service version code: 201091
D/UEI.SmartControl( 6878): Service requested: Control
E/UEI.SmartControl( 6878): Loading SETTINGS...
D/UEI.SmartControl( 6878): Request IControl service: devices are loaded...
I/QRemote ( 7341): [RemoteControlManager.java:183:onServiceConnected()] oooooo start
I/UEI.SmartControl( 6878): ------ IControl API: 11
D/UEI.SmartControl( 6878): File observer start...
E/UEI.SmartControl( 6878): IR Port is disabled: false
D/UEI.SmartControl( 6878): Starting file observer...
I/UEI.SmartControl( 6878): Registering callback...
D/UEI.SmartControl( 6878): Internal service binding...
I/UEI.SmartControl( 6878): ------ IControl API: 19
I/UEI.SmartControl( 6878): Registering Services Ready callback...
,D/UEI.SmartControl( 6878): -- Open brand translation xml: brands_translations_ko
I/UEI.SmartControl( 6878): Notify AllClients services are ready: 0
,I/QRemote ( 7341): [RemoteControlManager.java:660:QSSetupIsReady()] oooooo 140517:sdkIsReady callback... get functions. Result:0
D/QRemote ( 7341): [RemoteControlManager.java:388:handleMessage()] oooooo 140510:START_SESSION
D/QRemote ( 7341): [RemoteControlManager.java:394:handleMessage()] oooooo 140510:send retrieve msg
D/QRemote ( 7341): [RemoteControlManager.java:322:handleMessage()] oooooo 140510:handler call retrieveDevices
D/QRemote ( 7341): [RemoteControlManager.java:336:retrieveDevices()] oooooo retrieveDevices: start
I/UEI.SmartControl( 6878): ------ IControl API: 8
D/UEI.SmartControl( 6878): -----service ready thread exits
D/QRemote ( 7341): [RemoteControlManager.java:340:retrieveDevices()] oooooo retrieveDevices: 0
D/QRemote ( 7341): [RemoteControlManager.java:345:retrieveDevices()] oooooo retrieveDevices complete:true
D/QRemote ( 7341): [RemoteControlManager.java:353:retrieveDevices()] oooooo retrieveDevices: notifyDataSetChanged()
D/QRemote ( 7341): [QRemoteApplication.java:145:onRemoteControlStateChanged()] oooooo onRemoteControlStateChanged called in QRemoteApp
D/QRemote ( 7341): [QRemoteApplication.java:158:onRemoteControlStateChanged()] oooooo Widget count is [1]. send broadcast
D/QRemote ( 7341): [QRemoteApplication.java:160:onRemoteControlStateChanged()] oooooo Widget[0]:3
D/QRemote ( 7341): [QRemoteApplication.java:188:onRemoteControlStateChanged()] oooooo 140526:onRemoteControlStateChanged&sdkIsReady. stop Service
,V/QRemote ( 7341): [RemoteAppWidgetProvider.java:154:onReceive()] oooooo action name : android.appwidget.action.APPWIDGET_UPDATE
D/QRemote ( 7341): [RemoteAppWidgetProvider.java:449:onUpdate()] oooooo onUpdate()
E/QRemote ( 7341): [RemoteAppWidgetProvider.java:406:isLimitationView()] oooooo rotation : 0
D/QRemote ( 7341): [RemoteAppWidgetProvider.java:457:onUpdate()] oooooo onUpdate orientation:true
D/QRemote ( 7341): [RemoteAppWidgetProvider.java:480:onUpdate()] oooooo updateAppWidget to loading view
D/QRemote ( 7341): [RemoteAppWidgetProvider.java:506:onUpdate()] oooooo 140510:RetrieveDevices complete. Start loading
D/QRemote ( 7341): [RemoteAppWidgetProvider.java:508:onUpdate()] oooooo 140510:appWidgetIds[0]:3 loading
D/QRemote ( 7341): [RemoteAppWidgetManager.java:41:startLoading()] oooooo 140518:widgetId[3] loading start at [1452511953167]
D/QRemote ( 7341): [QRemoteService.java:207:onDestroy()] oooooo 140526:onDestroy
,I/ActivityManager( 1040): Killing 6166:com.android.contacts/u0a19 (adj 15): empty #17
D/QRemote ( 7341): [RemoteAppWidgetManager.java:239:doInBackground()] oooooo 140407:doinBack arr:0
,V/QRemote ( 7341): [RemoteAppWidgetProvider.java:154:onReceive()] oooooo action name : com.lge.qremote.action.widget_ui_update
W/libprocessgroup( 1040): failed to open /acct/uid_10019/pid_6166/cgroup.procs: No such file or directory
,E/QRemote ( 7341): [RemoteAppWidgetProvider.java:406:isLimitationView()] oooooo rotation : 0
D/QRemote ( 7341): [RemoteAppWidgetProvider.java:171:onReceive()] oooooo total:0
D/QRemote ( 7341): [RemoteAppWidgetProvider.java:172:onReceive()] oooooo selected:0
D/QRemote ( 7341): [RemoteAppWidgetProvider.java:173:onReceive()] oooooo arr:[]
D/QRemote ( 7341): [RemoteAppWidgetProvider.java:174:onReceive()] oooooo appWidgetId:3
D/QRemote ( 7341): [RemoteAppWidgetProvider.java:815:updateRemoteViews()] oooooo UpdateRemoteViews3:widgetId:3
D/QRemote ( 7341): [RemoteAppWidgetProvider.java:986:updateRemoteViews()] oooooo updateAppWidget5:widgetId:3]
,I/wpa_supplicant( 2670): Trying to associate with SSID 'NG700'
...
E/WifiStateMachine( 1040):  DisconnectedState SUPPLICANT_STATE_CHANGE_EVENT 26 0 rt=291010  SSID:  BSSID: 00:00:00:00:00:00 nid: -1 state: ASSOCIATING
W/Settings( 1040): Setting stay_on_while_plugged_in has moved from android.provider.Settings.System to android.provider.Settings.Global, returning read-only value.
W/Settings( 1040): Setting wifi_sleep_policy has moved from android.provider.Settings.System to android.provider.Settings.Global, returning read-only value.
D/WifiOffDelayIfNotUsed( 1040): NETWORK_STATE_CHANGED_ACTION [SCANNING]
...
I/StatusBar.NetworkController( 1462): mWifiConnected = false, mWifiLevel = 0
D/StatusBar.NetworkController( 1462): refreshViews: Data not connected!! Set no data type icon / Roaming
,E/WifiStateMachine( 1040):  ConnectModeState SUPPLICANT_STATE_CHANGE_EVENT 26 0 rt=291024  SSID:  BSSID: 00:00:00:00:00:00 nid: -1 state: ASSOCIATING
D/PostponalbeReceiver( 6692): WSAndroidSystemIntentReceiver is processing the broadcast action 'android.net.wifi.STATE_CHANGE'.
...
D/QRemote ( 7341): [WiFiStateReceiver.java:50:onReceive()] oooooo 140626:action:android.net.wifi.STATE_CHANGE
D/QRemote ( 7341): [WiFiStateReceiver.java:118:onReceive()] oooooo NETWORK_STATE_CHANGED_ACTION
I/QRemote ( 7341): [WiFiStateReceiver.java:201:onReceive()] oooooo The network is not connected. Don't handle that intent.
,I/wpa_supplicant( 2670): wlan0: Associated with c0:ff:d4:d3:aa:48
...
E/WifiStateMachine( 1040):  DisconnectedState SUPPLICANT_STATE_CHANGE_EVENT 27 0 rt=291114  SSID: NG700 BSSID: 00:00:00:00:00:00 nid: 0 state: ASSOCIATED
E/WifiStateMachine( 1040):  ConnectModeState SUPPLICANT_STATE_CHANGE_EVENT 27 0 rt=291115  SSID: NG700 BSSID: 00:00:00:00:00:00 nid: 0 state: ASSOCIATED
...
E/WifiStateMachine( 1040):  DisconnectedState CMD_ASSOCIATED_BSSID 28 0 BSSID=c0:ff:d4:d3:aa:48 Target=any roam=0 rt=291117
E/WifiStateMachine( 1040):  ConnectModeState CMD_ASSOCIATED_BSSID 28 0 BSSID=c0:ff:d4:d3:aa:48 Target=any roam=0 rt=291117
E/WifiStateMachine( 1040):  DriverStartedState CMD_ASSOCIATED_BSSID 28 0 BSSID=c0:ff:d4:d3:aa:48 Target=any roam=0 rt=291118
I/wpa_supplicant( 2670): wlan0: WPA: Key negotiation completed with c0:ff:d4:d3:aa:48 [PTK=CCMP GTK=CCMP]
I/wpa_supplicant( 2670): wlan0: CTRL-EVENT-CONNECTED - Connection to c0:ff:d4:d3:aa:48 completed [id=0 id_str=]
E/WifiStateMachine( 1040):  SupplicantStartedState CMD_ASSOCIATED_BSSID 28 0 BSSID=c0:ff:d4:d3:aa:48 Target=any roam=0 rt=291119
E/WifiStateMachine( 1040):  DefaultState CMD_ASSOCIATED_BSSID 28 0 BSSID=c0:ff:d4:d3:aa:48 Target=any roam=0 rt=291119
E/WifiStateMachine( 1040):  DisconnectedState SUPPLICANT_STATE_CHANGE_EVENT 29 0 rt=291120  SSID: NG700 BSSID: c0:ff:d4:d3:aa:48 nid: 0 state: FOUR_WAY_HANDSHAKE
...
W/Settings( 1040): Setting wifi_sleep_policy has moved from android.provider.Settings.System to android.provider.Settings.Global, returning read-only value.
D/WifiOffDelayIfNotUsed(, 1040): NETWORK_STATE_CHANGED_ACTION [CONNECTING]
,E/WifiStateMachine( 1040):  ConnectModeState SUPPLICANT_STATE_CHANGE_EVENT 29 0 rt=291127  SSID: NG700 BSSID: c0:ff:d4:d3:aa:48 nid: 0 state: FOUR_WAY_HANDSHAKE
...
E/WifiStateMachine( 1040):  SupplicantStartedState CMD_TETHER_STATE_CHANGE 0 0
E/WifiStateMachine( 1040):  DefaultState CMD_TETHER_STATE_CHANGE 0 0
E/WifiStateMachine( 1040):  DisconnectedState SUPPLICANT_STATE_CHANGE_EVENT 30 0 rt=291128  SSID: NG700 BSSID: c0:ff:d4:d3:aa:48 nid: 0 state: GROUP_HANDSHAKE
E/WifiStateMachine( 1040):  ConnectModeState SUPPLICANT_STATE_CHANGE_EVENT 30 0 rt=291129  SSID: NG700 BSSID: c0:ff:d4:d3:aa:48 nid: 0 state: GROUP_HANDSHAKE
E/WifiStateMachine( 1040):  DisconnectedState NETWORK_CONNECTION_EVENT 0 0 null nid=-1 rt=291129
E/WifiStateMachine( 1040):  ConnectModeState NETWORK_CONNECTION_EVENT 0 0 null nid=-1 rt=291129
...
D/UsbSettingsReceiver( 7283): [AUTORUN] onReceive() : app userid = 0, current userid = 0
D/UsbSettingsControl( 7283): [AUTORUN] getUsbConnected() : connected=true
D/UsbSettingsReceiver( 7283): [AUTORUN] onReceive() : availableList=[wlan0]
D/UsbSettingsReceiver( 7283): [AUTORUN] onReceive() : activeList=[]
D/UsbSettingsReceiver( 7283): [AUTORUN] onReceive() : errorList=[]
D/UsbSettingsControl( 7283): [AUTORUN] isAutorunTimer() : mAutorunChanging=false
D/UsbSettingsReceiver( 7283): [AUTORUN] onReceive() : TetherState Changed=wlan0
D/UsbSettingsControl( 7283): [AUTORUN] setTetherStatus() : status=false
D/PostponalbeReceiver( 6692): WSAndroidSystemIntentReceiver is processing the broadcast action 'android.net.wifi.STATE_CHANGE'.
...
E/WifiStateMachine( 1040):  ObtainingIpState SUPPLICANT_STATE_CHANGE_EVENT 33 0 rt=291189  SSID: NG700 BSSID: c0:ff:d4:d3:aa:48 nid: 0 state: COMPLETED
E/WifiStateMachine( 1040):  L2ConnectedState SUPPLICANT_STATE_CHANGE_EVENT 33 0 rt=291190  SSID: NG700 BSSID: c0:ff:d4:d3:aa:48 nid: 0 state: COMPLETED
E/WifiStateMachine( 1040):  ConnectModeState SUPPLICANT_STATE_CHANGE_EVENT 33 0 rt=291190  SSID: NG700 BSSID: c0:ff:d4:d3:aa:48 nid: 0 state: COMPLETED
D/DhcpStateMachine( 1040): StoppedState{ when=-2ms what=196609 target=com.android.internal.util.StateMachine$SmHandler }
D/DhcpStateMachine( 1040): WaitBeforeStartState
,D/QRemote ( 7341): [WiFiStateReceiver.java:50:onReceive()] oooooo 140626:action:android.net.wifi.STATE_CHANGE
D/QRemote ( 7341): [WiFiStateReceiver.java:118:onReceive()] oooooo NETWORK_STATE_CHANGED_ACTION
I/QRemote ( 7341): [WiFiStateReceiver.java:201:onReceive()] oooooo The network is not connected. Don't handle that intent.
E/WifiStateMachine( 1040):  ObtainingIpState SUPPLICANT_STATE_CHANGE_EVENT 34 0 rt=291193  SSID: NG700 BSSID: c0:ff:d4:d3:aa:48 nid: 0 state: COMPLETED
D/WifiServerServiceExt( 1040): SUPPLICANT_STATE_CHANGED_ACTION
D/WifiServerServiceExt( 1040): setSupplicantStateGROUP_HANDSHAKE
E/WifiStateMachine( 1040):  L2ConnectedState SUPPLICANT_STATE_CHANGE_EVENT 34 0 rt=291194  SSID: NG700 BSSID: c0:ff:d4:d3:aa:48 nid: 0 state: COMPLETED
E/WifiStateMachine( 1040):  ConnectModeState SUPPLICANT_STATE_CHANGE_EVENT 34 0 rt=291194  SSID: NG700 BSSID: c0:ff:d4:d3:aa:48 nid: 0 state: COMPLETED
...
,D/PostponalbeReceiver( 6692): WSAndroidSystemIntentReceiver is processing the broadcast action 'android.net.wifi.STATE_CHANGE'.
V/WiFiOffLoadBroadcast( 7283): WiFiOffLoadBroadcast: android.net.wifi.STATE_CHANGE
I/wpa_supplicant( 2670): wpa_driver_nl80211_ext_driver_cmd SETSUSPENDMODE 0
...
I/wpa_supplicant( 2670): wpa_driver_nl80211_ext_driver_cmd BTCOEXMODE 1
...
D/LGWifiP2pService( 1040): InactiveState{ when=-1ms what=143375 arg1=1 arg2=196615 obj=android.net.DhcpStateMachine@194fce95 target=com.android.internal.util.StateMachine$SmHandler }
D/LGWifiP2pService( 1040): P2pEnabledState{ when=-1ms what=143375 arg1=1 arg2=196615 obj=android.net.DhcpStateMachine@194fce95 target=com.android.internal.util.StateMachine$SmHandler }
...
I/wpa_supplicant( 2670): wpa_driver_nl80211_ext_driver_cmd SETSUSPENDMODE 1
...
W/dsqn    ( 7421): type=1400 audit(0.0:169): avc: denied { read write } for path="/dev/block/mmcblk0" dev="tmpfs" ino=6850 scontext=u:r:dsqn:s0 tcontext=u:object_r:mmc_block_device:s0 tclass=blk_file
D/ConnectivityManager.CallbackHandler( 1462): CM callback handler got msg 524290
,W/dsqn    ( 7421): type=1400 audit(0.0:170): avc: denied { read write } for path="/dev/block/mmcblk0" dev="tmpfs" ino=6850 scontext=u:r:dsqn:s0 tcontext=u:object_r:mmc_block_device:s0 tclass=blk_file
D/QRemote ( 7341): [WiFiStateReceiver.java:50:onReceive()] oooooo 140626:action:android.net.wifi.STATE_CHANGE
D/QRemote ( 7341): [WiFiStateReceiver.java:118:onReceive()] oooooo NETWORK_STATE_CHANGED_ACTION
I/QRemote ( 7341): [WiFiStateReceiver.java:201:onReceive()] oooooo The network is not connected. Don't handle that intent.
E/DSQN    ( 7421): DSQN ssw
,D/PostponalbeReceiver( 6692): WSAndroidSystemIntentReceiver is processing the broadcast action 'android.net.wifi.STATE_CHANGE'.
...
I/QRemote ( 7341): [WiFiStateReceiver.java:201:onReceive()] oooooo The network is not connected. Don't handle that intent.
D/PostponalbeReceiver( 6692): WSAndroidSystemIntentReceiver is processing the broadcast action 'android.net.wifi.STATE_CHANGE'.
I/PCSuite ( 7320): [StartReceiver]NETWORK_STATE_CHANGED_ACTION : CONNECTED
D/PCSuite ( 7320): [StartReceiver][LGSW]false, [WIFIUI]false, [WIFI]true, [HOTSPOT]false, [OBEXSERVICE]false
,V/WiFiOffLoadBroadcast( 7283): WiFiOffLoadBroadcast: android.net.wifi.STATE_CHANGE
D/WiFiOffLoadBroadcast( 7283): MCCMNC not supported: null
D/QRemote ( 7341): [WiFiStateReceiver.java:50:onReceive()] oooooo 140626:action:android.net.wifi.STATE_CHANGE
D/QRemote ( 7341): [WiFiStateReceiver.java:118:onReceive()] oooooo NETWORK_STATE_CHANGED_ACTION
D/libc-netbsd(  312): res_queryN name = clients3.google.com succeed
D/QRemote ( 7341): [WiFiStateReceiver.java:123:onReceive()] oooooo The network is connected.
I/QRemote ( 7341): [Constants.java:311:getHomeWifiIdList()] oooooo There are not stored home Wi-Fi networks.
I/QRemote ( 7341): [WiFiStateReceiver.java:178:onReceive()] oooooo There are no stored BSSIDs.
,D/PostponalbeReceiver( 6692): WSAndroidSystemIntentReceiver is processing the broadcast action 'android.net.wifi.STATE_CHANGE'.
I/PCSuite ( 7320): [StartReceiver]NETWORK_STATE_CHANGED_ACTION : CONNECTED
D/PCSuite ( 7320): [StartReceiver][LGSW]false, [WIFIUI]false, [WIFI]true, [HOTSPOT]false, [OBEXSERVICE]false
V/WiFiOffLoadBroadcast( 7283): WiFiOffLoadBroadcast: android.net.wifi.STATE_CHANGE
...
I/QRemote ( 7341): [Constants.java:311:getHomeWifiIdList()] oooooo There are not stored home Wi-Fi networks.
I/QRemote ( 7341): [WiFiStateReceiver.java:178:onReceive()] oooooo There are no stored BSSIDs.
,D/NetworkMonitor NetworkAgentInfo [WIFI () - null]( 1040): isCaptivePortal: ret=204 headers={null=[HTTP/1.1 204 No Content], Content-Length=[0], Date=[Mon, 11 Jan 2016 11:32:34 GMT], Server=[GFE/2.0], X-Android-Received-Millis=[1452511954052], X-Android-Response-Source=[NETWORK 204], X-Android-Sent-Millis=[1452511954032]}
...
W/dhcpcd  ( 7427): type=1400 audit(0.0:171): avc: denied { read write } for path="/dev/block/mmcblk0" dev="tmpfs" ino=6850 scontext=u:r:dhcp:s0 tcontext=u:object_r:mmc_block_device:s0 tclass=blk_file
,W/dhcpcd  ( 7427): type=1400 audit(0.0:172): avc: denied { read write } for path="/dev/block/mmcblk0" dev="tmpfs" ino=6850 scontext=u:r:dhcp:s0 tcontext=u:object_r:mmc_block_device:s0 tclass=blk_file
I/dhcpcd  ( 7427): version 5.5.6 starting
E/dhcpcd  ( 7427): get_duid: m
D/dhcpcd  ( 7427): wlan0: using ClientID 01:c4:9a:02:7b:60:ac
D/dhcpcd  ( 7427): wlan0: executing `/system/etc/dhcpcd/dhcpcd-run-hooks', reason PREINIT
,D/dhcpcd  ( 7427): getUsingAPMacAddress: c0:ff:d4:d3:aa:48 , return 1
,D/dhcpcd  ( 7427): [read_lease] unlink /data/misc/dhcp/dhcpcd-wlan0.lease, link /data/misc/dhcp/dhcpcd-wlan0-c0:ff:d4:d3:aa:48.lease2
D/dhcpcd  ( 7427): wlan0: reading lease `/data/misc/dhcp/dhcpcd-wlan0.lease'
I/dhcpcd  ( 7427): wlan0: rebinding lease of 192.168.1.141
D/dhcpcd  ( 7427): wlan0: sending REQUEST (xid 0xd382568), next in 4.98 seconds
...
,D/Tethering( 1040): MasterInitialState.processMessage what=3
,I/NetworkMonitor( 5926): type=WIFI subType= reason=null isConnected=true
I/NetworkMonitor( 5926): type=WIFI subType= reason=null isConnected=true
D/GpsLocationProvider( 1040): receive broadcast intent, action: android.net.conn.CONNECTIVITY_CHANGE
...
I/ActivityManager( 1040): Start proc com.lge.appbox.client for broadcast com.lge.appbox.client/com.lge.appbox.receiver.NetworkStateForAutoUpdateMonitor: pid=7453 uid=10011 gids={50011, 9997, 3003, 1028, 1015, 2001} abi=armeabi-v7a
,I/AppUp4:AppBoxCP( 7453): onCreate
,W/AppUp4:DB( 7453):  [AppBoxDatabaseHelper] construct
I/AppUp4:DB( 7453):  setFingerPrint start
I/AppUp4:DB( 7453):  newfinger = lge/g3_global_com/g3:5.0/LRX21R.A1421650137/1421650137:user/release-keys SDK version = 21
I/AppUp4:DB( 7453):  beforefinger = lge/g3_global_com/g3:5.0/LRX21R.A1421650137/1421650137:user/release-keys
I/AppUp4:DB( 7453):  SDK version = 21
I/AppUp4:DB( 7453):  beforefinger == newfinger no write in DB
D/AppUp4:AppBoxApplication( 7453): AppBoxApplication onCreate()
,I/NetworkStateForAutoUpdateMonitor( 7453): [onReceive] BroadcastReceiver onReceive
I/NetworkStateForAutoUpdateMonitor( 7453): [onReceive] intent action : android.net.conn.CONNECTIVITY_CHANGE
I/NetworkStateForAutoUpdateMonitor( 7453): [onReceive] connect :true
I/NetworkStateForAutoUpdateMonitor( 7453): [onReceive] request level :IDLE....
I/AppUp4:CustModeStarterReceiver( 7453): onReceive
,D/LgDataFeature( 7453): LgDataFeature() Constructor: none
,D/LgDataFeature( 7453): LgDataFeature() Constructor Done, null
,D/AppUp4:CustFacade( 7453): Context : android.app.ReceiverRestrictedContext@a04ddf1
D/AppUp4:CustFacade( 7453): isCustomizationCompleted : false
D/AppUp4:CustFacade( 7453): isPhone : true
D/AppUp4:CustModeStarterReceiver( 7453): begin check event
I/AppUp4:CustModeStarterReceiver( 7453): Event For GoodConnectivity
D/AppUp4:CustModeStarterReceiver( 7453): runCustWithNotification goAsync : ReceiverData{intent=Intent { act=android.net.conn.CONNECTIVITY_CHANGE flg=0x4000010 cmp=com.lge.appbox.client/com.lge.appbox.cust.CustModeStarterReceiver (has extras) } packageName=com.lge.appbox.client resultCode=0 resultData=null resultExtras=null}
D/AppUp4:CustModeStarterReceiver( 7453): call method handleAsyncCustNotification.
D/AppUp4:CustModeStarterReceiver( 7453): handleAsync isTriedOnce : false
E/AppUp4:CustModeStarterReceiver( 7453): handleAsyncCustNotification do not startCustService
I/ActivityManager( 1040): Killing 6742:com.lge.email/u0a23 (adj 15): empty #17
,D/LGDMClient( 4346): [DmDeviceActionReceiver.java] [onReceive()] : [128] : Device Action Receiver android.net.conn.CONNECTIVITY_CHANGE
W/libprocessgroup( 1040): failed to open /acct/uid_10023/pid_6742/cgroup.procs: No such file or directory
,D/LGDMClient( 4346): [DmDeviceActionReceiver.java] [doAction()] : [60] : Device Action doAction
W/ContextImpl( 4346): Calling a method in the system process without a qualified user: android.app.ContextImpl.startService:1757 android.content.ContextWrapper.startService:515 com.lge.lgdmsclient.dmclient.agent.DmDeviceActionReceiver.doAction:78 com.lge.lgdmsclient.dmclient.agent.DmDeviceActionReceiver.onReceive:132 android.app.ActivityThread.handleReceiver:2586 
,W/ContextImpl( 4346): Calling a method in the system process without a qualified user: android.app.ContextImpl.startService:1757 android.content.ContextWrapper.startService:515 com.lge.lgdmsclient.dmclient.agent.DmDeviceActionReceiver.doAction:82 com.lge.lgdmsclient.dmclient.agent.DmDeviceActionReceiver.onReceive:132 android.app.ActivityThread.handleReceiver:2586 
V/DownloadManager( 3373): Received broadcast intent for android.net.conn.CONNECTIVITY_CHANGE
,D/LGDMClient( 4346): [DmUtil.java] [getServiceTypeBasedOnAgentState()] : [672] : iAgentState=3, isUserType=1
V/DownloadManager( 3373): DownloadService onCreate
I/LGDMClient( 4346): [DmServiceProcessor.java] [processNetworkChanged()] : [91] : networkStateChanged [DeviceServiceType:Full Mode]--> NetworkType : WIFI is connected.
,D/LGDMClient( 4346): [GCMRegisterService.java] [onHandleIntent()] : [47] : Intent : android.net.conn.CONNECTIVITY_CHANGE
D/LGDMClient( 4346): [GCMRegisterService.java] [onHandleIntent()] : [56] : ConnectivityManager is not null
...
,V/DownloadManager( 3373): created cursor android.database.sqlite.SQLiteCursor@e8d1f3c on behalf of 3373
...
I/ActivityManager( 1040): Start proc com.lge.email for broadcast com.lge.email/.adapter.eas.EasBroadcastReceiver: pid=7483 uid=10023 gids={50023, 9997, 3003, 4002, 1023, 1028, 1015, 3001, 3002} abi=armeabi-v7a
,V/DownloadManager( 3373): created cursor android.database.sqlite.SQLiteCursor@2c7ffe1a on behalf of 3373
...
W/ContextImpl( 4346): Calling a method in the system process without a qualified user: android.app.ContextImpl.startService:1757 android.content.ContextWrapper.startService:515 com.lge.lgdmsclient.service.DmServiceProcessor.processNetworkChanged:141 com.lge.lgdmsclient.service.DmServiceProcessor.onHandleIntent:180 android.app.IntentService$ServiceHandler.handleMessage:65 
E/LGDMClient( 4346): [DmNotiService.java] [onCreate()] : [148] : DmNotiService.onCreate()
,V/DownloadManager( 3373): created cursor android.database.sqlite.SQLiteCursor@13aaf328 on behalf of 3373
D/LGDMClient( 4346): [DmNotiService.java] [onStartCommand()] : [182] : in the new onStartCommand()
D/LGDMClient( 4346): [DmNotiService.java] [handleStart()] : [203] : IN SERVICE IntentActioncom.lge.dm.dmclient.intent.SYSTEM_NETWORK_CHANGED
...
,W/ResourcesManager( 7483): Asset path '/system/framework/com.lge.mdm.jar' does not exist or contains no resources.
W/ResourcesManager( 7483): Asset path '/system/framework/qcrilhook.jar' does not exist or contains no resources.
W/ResourcesManager( 7483): Asset path '/system/framework/com.lge.zdi.splitwindow.jar' does not exist or contains no resources.
...
I/LGEmail ( 7483): [lifecycle]--onCreate() (at EmailMainApp.java onCreate 179)[v:null]
,I/dhcpcd  ( 7427): wlan0: acknowledged 192.168.1.141 from 192.168.1.1
D/LGEmail ( 7483): user build Type == true (at Util.java isUserModeBuildType 3507)[v:6.41.18]
W/ResourceType( 7483): No package identifier when getting value for resource number 0x00000000
,I/dhcpcd  ( 7427): wlan0: leased 192.168.1.141 for 86400 seconds
D/dhcpcd  ( 7427): wlan0: adding IP address 192.168.1.141/24
,D/dhcpcd  ( 7427): wlan0: adding route to 192.168.1.0/24
D/dhcpcd  ( 7427): wlan0: adding default route via 192.168.1.1
D/dhcpcd  ( 7427): wlan0: writing lease `/data/misc/dhcp/dhcpcd-wlan0.lease'
D/dhcpcd  ( 7427): getUsingAPMacAddress: c0:ff:d4:d3:aa:48 , return 1
D/dhcpcd  ( 7427): write_lease_ext: /data/misc/dhcp/dhcpcd-wlan0-c0:ff:d4:d3:aa:48.lease2
D/dhcpcd  ( 7427): wlan0: executing `/system/etc/dhcpcd/dhcpcd-run-hooks', reason REBOOT
D/LgDataFeature( 7483): LgDataFeature() Constructor: none
D/LgDataFeature( 7483): LgDataFeature() Constructor Done, null
,D/eas_req ( 7483): ---addEventToQueue() easCode=2, requestId=0 (at EasSupport.java addEventToQueue 69)
,I/ActivityManager( 1040): Start proc com.lge.formmanager for broadcast com.lge.formmanager/.FormServiceReceiver: pid=7529 uid=10026 gids={50026, 9997, 3003, 1028} abi=armeabi-v7a
,I/HubEmail( 7483): JNI_OnLoad()
I/HubEmail( 7483): -- called from 1935 ../../Build/Android_r4/../../SDK/Native/EmailCoreLinkJni.cpp
I/HubEmail( 7483): registerNatives()
I/HubEmail( 7483): -- called from 1905 ../../Build/Android_r4/../../SDK/Native/EmailCoreLinkJni.cpp
I/HubEmail( 7483): registerNativeMethods()
I/HubEmail( 7483): -- called from 1774 ../../Build/Android_r4/../../SDK/Native/EmailCoreLinkJni.cpp
W/art     ( 7483): JNI RegisterNativeMethods: attempt to register 0 native methods for com.lge.email.jni.EmailCoreLink
I/ActivityManager( 1040): Killing 6772:com.android.gallery3d/u0a27 (adj 15): empty #17
...
,W/Settings( 7483): Setting airplane_mode_on has moved from android.provider.Settings.System to android.provider.Settings.Global, returning read-only value.
W/libprocessgroup( 1040): failed to open /acct/uid_10027/pid_6772/cgroup.procs: No such file or directory
W/Settings( 7483): Setting airplane_mode_on has moved from android.provider.Settings.System to android.provider.Settings.Global, returning read-only value.
...
,I/ActivityManager( 1040): Start proc com.android.chrome for broadcast com.android.chrome/com.google.android.apps.chrome.precache.PrecacheServiceLauncher: pid=7553 uid=10057 gids={50057, 9997, 3003, 1028, 1015} abi=armeabi-v7a
...
,V/FormManager( 7529): There are no updated forms. The schedule will be deleted.
,V/FormManager( 7529): Alarm would be updated, because LastCheckTime has been updated.
I/ActivityManager( 1040): Start proc com.lge.drmservice for broadcast com.lge.drmservice/.DrmBroadcastReceiver: pid=7574 uid=10062 gids={50062, 9997, 4002, 3003, 1028} abi=armeabi-v7a
,I/ActivityManager( 1040): Killing 6798:com.google.android.apps.docs/u0a61 (adj 15): empty #17
W/libprocessgroup( 1040): failed to open /acct/uid_10061/pid_6798/cgroup.procs: No such file or directory
,I/ActivityManager( 1040): Killing 6839:com.lge.lockscreensettings/u0a80 (adj 15): empty #17
,I/ActivityManager( 1040): Start proc com.lge.sizechangable.weather for broadcast com.lge.sizechangable.weather/.layout.WeatherWidget: pid=7595 uid=10085 gids={50085, 9997, 3003, 1028, 1015} abi=armeabi-v7a
,W/libprocessgroup( 1040): failed to open /acct/uid_10080/pid_6839/cgroup.procs: No such file or directory
I/ActivityManager( 1040): Killing 6913:com.lge.eula/1000 (adj 15): empty #17
...
W/libprocessgroup( 1040): failed to open /acct/uid_1000/pid_6913/cgroup.procs: No such file or directory
...
I/art     ( 7595): Almond Protected OAT
,D/WeatherApplication( 7595): removeAccount
,D/WeatherApplication( 7595): Account.length = 0
E/WeatherApplication( 7595): OPERATOR:OPEN
D/WeatherAncestor( 7595): 2 : onReceive, action: android.net.conn.CONNECTIVITY_CHANGE, Time(hour:min:sec) 12:32:36
D/Weather.Utils( 7595): 2 : the weather widgets(using time tick) are gone.
D/Weather.Utils( 7595): 2 : All the weather widget is gone.
D/UpdateThreadPoolManager( 7595): 2 : This is isUpdating : false
D/WeatherAncestor( 7595): connectivity changed - connection : true
,D/WeatherService( 7595): 2 : isServiceAlived():false forecastCache:null
D/ForecastDataCache( 7595): 2 : lastUpdatedTime: 1430558561343
D/ForecastDataCache( 7595): 2 : currentPackageVersion: 4.40.4
D/ForecastDataCache( 7595): 2 : Cache is not up-to-date, count: 0
D/Weather_cast( 7595): 2 : isUpdateNeedForAlarm : no city return false
D/WeatherAncestor( 7595): 2 : onReceive has processed, action: android.net.conn.CONNECTIVITY_CHANGE, Time(hour:min:sec) 12:32:36
,I/ActivityManager( 1040): Start proc com.google.android.apps.magazines for broadcast com.google.android.apps.magazines/com.google.apps.dots.android.newsstand.appwidget.NewsWidgetProvider: pid=7613 uid=10093 gids={50093, 9997, 3003, 1028, 1015} abi=armeabi-v7a
,I/ActivityManager( 1040): Killing 6931:com.lge.bnr/1000 (adj 15): empty #17
W/libprocessgroup( 1040): failed to open /acct/uid_1000/pid_6931/cgroup.procs: No such file or directory
...
I/LibraryLoader( 7613): Time to load native libraries: 3 ms (timestamps 4512-4515)
I/LibraryLoader( 7613): Expected native library version number "",actual native library version number ""
V/WebViewChromiumFactoryProvider( 7613): Binding Chromium to main looper Looper (main, tid 1) {38f990e0}
I/LibraryLoader( 7613): Expected native library version number "",actual native library version number ""
...
V/AudioPolicyService(  316): registerClient() client 0xb100dc00, uid 10093
...
,I/ActivityManager( 1040): Killing 6964:com.google.android.gms.wearable/u0a5 (adj 15): empty #17
,W/libprocessgroup( 1040): failed to open /acct/uid_10005/pid_6964/cgroup.procs: No such file or directory
...
D/AppUp4:CustFacade( 7453): isPhone : true
D/AppUp4:CustModeStarterReceiver( 7453): begin check event
I/AppUp4:CustModeStarterReceiver( 7453): Event For GoodConnectivity, noConnectivity : false, but skip! 
D/LGDMClient( 4346): [DmDeviceActionReceiver.java] [onReceive()] : [128] : Device Action Receiver android.net.conn.CONNECTIVITY_CHANGE
D/LGDMClient( 4346): [DmDeviceActionReceiver.java] [doAction()] : [60] : Device Action doAction
W/ContextImpl( 4346): Calling a method in the system process without a qualified user: android.app.ContextImpl.startService:1757 android.content.ContextWrapper.startService:515 com.lge.lgdmsclient.dmclient.agent.DmDeviceActionReceiver.doAction:78 com.lge.lgdmsclient.dmclient.agent.DmDeviceActionReceiver.onReceive:132 android.app.ActivityThread.handleReceiver:2586 
W/ContextImpl( 4346): Calling a method in the system process without a qualified user: android.app.ContextImpl.startService:1757 android.content.ContextWrapper.startService:515 com.lge.lgdmsclient.dmclient.agent.DmDeviceActionReceiver.doAction:82 com.lge.lgdmsclient.dmclient.agent.DmDeviceActionReceiver.onReceive:132 android.app.ActivityThread.handleReceiver:2586 
...
I/LGDMClient( 4346): [DmServiceProcessor.java] [processNetworkChanged()] : [91] : networkStateChanged [DeviceServiceType:Full Mode]--> NetworkType : WIFI is connected.
,V/DownloadManager( 3373): created cursor android.database.sqlite.SQLiteCursor@2a8fe1e6 on behalf of 3373
I/DownloadManager( 3373): in removeSpuriousFiles, preserving file /storage/emulated/0/.dwnld/LGMyGuide_4.40.09_COM_COM_20150430011620058_RELG-D855.apk
I/DownloadManager( 3373): in removeSpuriousFiles, preserving file /storage/emulated/0/.dwnld/LGBackup_4.50.37_COM_COM_20150608234245157.apk
I/DownloadManager( 3373): in removeSpuriousFiles, preserving file /storage/emulated/0/.dwnld/CalendarProvider_4.2.8_COM_COM_20150304234552863_RELG-D855.apk
I/DownloadManager( 3373): in removeSpuriousFiles, preserving file /storage/emulated/0/.dwnld/Calendar_4.40.16_COM_COM_20150304234554754_RELG-D855.apk
...
I/DownloadManager( 3373): in trimDatabase
V/DownloadManager( 3373): starting query, database is not null; projection[0] is _id; selection is status >= '200'; selectionArgs is null; sort is lastmod.
V/DownloadManager( 3373): created cursor android.database.sqlite.SQLiteCursor@35f1c77d on behalf of 3373
,W/Settings( 7483): Setting airplane_mode_on has moved from android.provider.Settings.System to android.provider.Settings.Global, returning read-only value.
...
V/DownloadManager( 3373): created cursor android.database.sqlite.SQLiteCursor@2a683672 on behalf of 3373
D/LgeQuickCoverNotificationData( 1420): isNotificationForCurrentUser : true
...
D/QuickStatusbarLayout( 1420): child = android.widget.LinearLayout{585e79 V.E..... ......ID 0,0-798,100 #7f0f0041 app:id/notification_icon_area} ,w = 798
W/ContextImpl( 4346): Calling a method in the system process without a qualified user: android.app.ContextImpl.startService:1757 android.content.ContextWrapper.startService:515 com.lge.lgdmsclient.service.DmServiceProcessor.processNetworkChanged:141 com.lge.lgdmsclient.service.DmServiceProcessor.onHandleIntent:180 android.app.IntentService$ServiceHandler.handleMessage:65 
W/Settings( 7483): Setting airplane_mode_on has moved from android.provider.Settings.System to android.provider.Settings.Global, returning read-only value.
E/LGDMClient( 4346): [DmNotiService.java] [onCreate()] : [148] : DmNotiService.onCreate()
D/LGDMClient( 4346): [DmNotiService.java] [onStartCommand()] : [182] : in the new onStartCommand()
D/LGDMClient( 4346): [DmNotiService.java] [handleStart()] : [203] : IN SERVICE IntentActioncom.lge.dm.dmclient.intent.SYSTEM_NETWORK_CHANGED
I/art     ( 1040): Explicit concurrent mark sweep GC freed 85047(3MB) AllocSpace objects, 2(32KB) LOS objects, 33% free, 44MB/66MB, paused 2.171ms total 177.021ms
,V/DownloadManager( 3373): processing inserted download 1
V/DownloadManager( 3373): processing inserted download 4
V/DownloadManager( 3373): processing inserted download 7
V/DownloadManager( 3373): processing inserted download 8
...
V/DownloadManager( 3373): processing inserted download 18
V/DownloadManager( 3373): processing inserted download 21
D/WeatherAncestor( 7595): 2 : onReceive, action: android.net.conn.CONNECTIVITY_CHANGE, Time(hour:min:sec) 12:32:37
D/Weather.Utils( 7595): 2 : the weather widgets(using time tick) are gone.
,D/Weather.Utils( 7595): 2 : All the weather widget is gone.
D/UpdateThreadPoolManager( 7595): 2 : This is isUpdating : false
D/WeatherAncestor( 7595): connectivity changed - connection : true
D/WeatherService( 7595): 2 : isServiceAlived():false forecastCache:com.lge.sizechangable.weather.data.core.ForecastDataCache@31e01857
D/ForecastDataCache( 7595): 2 : lastUpdatedTime: 1430558561343
D/ForecastDataCache( 7595): 2 : currentPackageVersion: 4.40.4
D/ForecastDataCache( 7595): 2 : Cache is up-to-date, count: 0
D/Weather_cast( 7595): 2 : isUpdateNeedForAlarm : no city return false
D/WeatherAncestor( 7595): 2 : onReceive has processed, action: android.net.conn.CONNECTIVITY_CHANGE, Time(hour:min:sec) 12:32:37
V/DownloadManager( 3373): DownloadService onDestroy
D/ChimeraCfgMgr( 2366): Loading module com.google.android.gms.kids from APK com.google.android.gms
,V/FormManager( 7529): There are no updated forms. The schedule will be deleted.
D/PostponalbeReceiver( 6692): WSAndroidSystemIntentReceiver is processing the broadcast action 'android.net.conn.CONNECTIVITY_CHANGE'.
...
D/LGDMClient( 4346): [GCMRegisterService.java] [onHandleIntent()] : [47] : Intent : android.net.conn.CONNECTIVITY_CHANGE
D/LGDMClient( 4346): [GCMRegisterService.java] [onHandleIntent()] : [56] : ConnectivityManager is not null
V/DownloadManager( 3373): created cursor android.database.sqlite.SQLiteCursor@17eff40 on behalf of 3373
W/ContextImpl( 4346): Calling a method in the system process without a qualified user: android.app.ContextImpl.startService:1757 android.content.ContextWrapper.startService:515 com.lge.lgdmsclient.service.DmServiceProcessor.processNetworkChanged:141 com.lge.lgdmsclient.service.DmServiceProcessor.onHandleIntent:180 android.app.IntentService$ServiceHandler.handleMessage:65 
,I/DownloadManager( 3373): in removeSpuriousFiles, preserving file /storage/emulated/0/.dwnld/LGMyGuide_4.40.09_COM_COM_20150430011620058_RELG-D855.apk
I/DownloadManager( 3373): in removeSpuriousFiles, preserving file /storage/emulated/0/.dwnld/LGBackup_4.50.37_COM_COM_20150608234245157.apk
I/DownloadManager( 3373): in removeSpuriousFiles, preserving file /storage/emulated/0/.dwnld/CalendarProvider_4.2.8_COM_COM_20150304234552863_RELG-D855.apk
...
D/LGDMClient( 4346): [DmNotiService.java] [onStartCommand()] : [182] : in the new onStartCommand()
D/LGDMClient( 4346): [DmNotiService.java] [handleStart()] : [203] : IN SERVICE IntentActioncom.lge.dm.dmclient.intent.SYSTEM_NETWORK_CHANGED
V/DownloadManager( 3373): created cursor android.database.sqlite.SQLiteCursor@1cff47be on behalf of 3373
W/Settings( 7483): Setting airplane_mode_on has moved from android.provider.Settings.System to android.provider.Settings.Global, returning read-only value.
,I/LgeMiscReceiver( 3345): intent = Intent { act=android.net.conn.CONNECTIVITY_CHANGE flg=0x4000010 cmp=com.android.mms/.transaction.LgeMiscReceiver (has extras) }
I/LgeMiscReceiver( 3345): action = android.net.conn.CONNECTIVITY_CHANGE
...
W/Settings( 7483): Setting airplane_mode_on has moved from android.provider.Settings.System to android.provider.Settings.Global, returning read-only value.
V/DownloadManager( 3373): starting query, database is not null; projection is null; selection is null; selectionArgs is null; sort is null.
V/DownloadManager( 3373): created cursor android.database.sqlite.SQLiteCursor@2bf4cf6c on behalf of 3373
,V/DownloadManager( 3373): processing inserted download 1
,D/WeatherAncestor( 7595): 2 : onReceive, action: android.net.conn.CONNECTIVITY_CHANGE, Time(hour:min:sec) 12:32:37
V/DownloadManager( 3373): processing inserted download 4
V/DownloadManager( 3373): processing inserted download 7
...
D/QuickStatusbarLayout( 1420): Notification difference=198
D/QuickStatusbarLayout( 1420): child = android.widget.LinearLayout{585e79 V.E..... ......ID 0,0-798,100 #7f0f0041 app:id/notification_icon_area} ,w = 798
,D/UEI.SmartControl( 6878): Internal timer expired: 3
D/UEI.SmartControl( 6878): unbind internal service
D/libc-netbsd(  312): default dns: query_ipv6=0, query_ipv4=1
...
D/libc-netbsd(  312): res_queryN name = clients3.google.com, class = 1, type = 1
D/libc-netbsd(  312): res_queryN name = clients3.google.com succeed
D/serial_port( 6878): close(fd = 24)
I/UEI.SmartControl( 6878): Serial port is closed.
,V/WifiInternetCheck( 1040): isHttpConnectionAvailable - We got a valid response : 204
I/jxcore-log( 7196): Test app app.js loaded
I/jxcore-log( 7196): 
,I/Choreographer( 7196): Skipped 430 frames!  The application may be doing too much work on its main thread.
...
I/jxcore-log( 7196): 
,D/AndroidRuntime( 7723): 
D/AndroidRuntime( 7723): >>>>>> AndroidRuntime START com.android.internal.os.RuntimeInit <<<<<<
,D/AndroidRuntime( 7723): CheckJNI is OFF
D/AndroidRuntime( 7723): Calling main entry com.android.commands.pm.Pm
,I/ActivityManager( 1040): Force stopping com.test.thalitest appid=10311 user=-1: uninstall pkg
,I/ActivityManager( 1040): Killing 7196:com.test.thalitest/u0a311 (adj 0): stop com.test.thalitest
I/WindowState( 1040): WIN DEATH: Window{2e433950 u0 com.test.thalitest/com.test.thalitest.MainActivity}
,D/WifiService( 1040): Client connection lost with reason: 4
D/InputDispatcher( 1040): Window went away: Window{2e433950 u0 com.test.thalitest/com.test.thalitest.MainActivity}
,W/PackageSettings( 1040): Skipping PackageSetting{2d8d3709 com.example.hello/10319} due to missing metadata
,E/libprocessgroup( 1040): failed to kill 1 processes for processgroup 7196
,I/ActivityManager( 1040):   Force finishing activity ActivityRecord{55c4a25 u0 com.test.thalitest/.MainActivity t4}
,E/GBMv2   (  336): DFP En is all cleared set to be enabled
W/ActivityManager( 1040): Spurious death for ProcessRecord{3dc7910b 7196:com.test.thalitest/u0a311}, curProc for 7196: null
,I/ActivityManager( 1040): Force stopping com.test.thalitest appid=10311 user=0: pkg removed
I/ActivityManager( 1040):   Force finishing activity ActivityRecord{55c4a25 u0 com.test.thalitest/.MainActivity t4 f}
W/ActivityManager( 1040): Duplicate finish request for ActivityRecord{55c4a25 u0 com.test.thalitest/.MainActivity t4 f}
,I/[LGHome]EVENT( 2080): [Launcher.java:5338:onStart()]onStart
D/SplitWindowPolicy( 1970): updateActivityStateChanged: resumed=false, screenId=0, isScreenFull=false
D/SplitWindowPolicy( 1970): topRunningActivity=ActivityInfo{4483e01 co.....Launcher}, taskId=3, activityType=1, bIsSplit=false
I/[LGHome]EVENT( 2080): [Launcher.java:903:onResume()]onResume
D/SplitWindowPolicy( 1970): updateActivityStateChanged: resumed=true, screenId=0, isScreenFull=false
D/SplitWindowPolicy( 1970): topRunningActivity=ActivityInfo{b6ce4a6 co.....Launcher}, taskId=3, activityType=1, bIsSplit=false
I/[LGHome]EVENT( 2080): [LauncherModel.java:1352:startLoader()]startLoader isLaunching=true
I/[LGHome]Launcher.Model( 2080): [LauncherModel.java:1469:loadAndBindWorkspace()]loadAndBindWorkspace=0ms
,D/KeyguardModel( 1462): mPackageIntentReceiver, received action: android.intent.action.PACKAGE_REMOVED, sendingUserId:0
D/LIA_Service_RemotePackageHandler( 2035): onReceive action : android.intent.action.PACKAGE_REMOVED = package:com.test.thalitest
...
I/[LGHome]GBoardWebView( 2080): [GBoardWebView.java:306:loadCacheBitmapPostDelayed()]loadCacheBitmapPostDelayed() delay:1
...
,I/art     ( 4629): Explicit concurrent mark sweep GC freed 15072(878KB) AllocSpace objects, 0(0B) LOS objects, 35% free, 29MB/45MB, paused 693us total 80.856ms
V/SIM_STK ( 1040): Menu title from STK is T-Mobile
,D/administrator( 1040): Handling package changes for user 0
,I/ActivityManager( 1040): Start proc com.lge.lockscreensettings for content provider com.lge.lockscreensettings/.LockSettingsProvider: pid=7757 uid=10080 gids={50080, 9997, 1028, 1015} abi=armeabi-v7a
,I/[LGHome]LGActivityUtil( 2080): [LGActivityUtil.java:319:notifyToWeatherWidget()]broadcast to weather widget, intent: Intent { act=com.lge.launcher2.RESUME }
I/[SystemUI]QSlideListController( 1462): onReceive = android.intent.action.PACKAGE_REMOVED
I/[LGHome]EVENT( 2080): [Launcher.java:1056:onResume()]onResume end
I/[LGHome]EVENT( 2080): [Launcher.java:1114:onPause()]onPause
...
I/[LGHome]GBoardWebView( 2080): [GBoardWebView.java:247:writeCacheBitmapPostDelayed()]writeCacheBitmapPostDelayed() delay: we don't have a change point1
...
I/GBoardWebViewUtils( 2080): checkExpiredAndRemoveCard() card: GBoardCard = { id: mw_initial
I/GBoardWebViewUtils( 2080): , create_time: 1430558575574
I/GBoardWebViewUtils( 2080): , expire_time: 0
I/GBoardWebViewUtils( 2080): , raw_uri: file:///system/etc/mrg_default_forms/MyWellness/initial/initial.html?id=mw_initial
I/GBoardWebViewUtils( 2080): , category: com.lge.intent.category.gboard.MYWELLNESS
I/GBoardWebViewUtils( 2080): , display: false
I/GBoardWebViewUtils( 2080): , animation: false }
I/GBoardWebViewUtils( 2080): checkExpiredAndRemoveCard() card: GBoardCard = { id: dyk000
I/GBoardWebViewUtils( 2080): , create_time: 1430558575600
I/GBoardWebViewUtils( 2080): , expire_time: 0
I/GBoardWebViewUtils( 2080): , raw_uri: file:///system/etc/mrg_default_forms/MyGuide/GBoard/Initial/initial.html?id=dyk000&appname=[@string/sp_smart_tips_text]&desc=[@string/gboard_st_initialcard_desc]
I/GBoardWebViewUtils( 2080): , category: com.lge.intent.category.gboard.DOYOUKNOW
I/GBoardWebViewUtils( 2080): , display: false
I/GBoardWebViewUtils( 2080): , animation: false }
I/GBoardWebViewUtils( 2080): checkExpiredAndRemoveCard() card: GBoardCard = { id: guide_1111111111116_1452175674810
I/GBoardWebViewUtils( 2080): , create_time: 1452175675684
I/GBoardWebViewUtils( 2080): , expire_time: 0
I/GBoardWebViewUtils( 2080): , raw_uri: file:///system/etc/mrg_default_forms/MyGuide/GBoard/UserGuideCard/1/userguide.html?id=guide_1111111111116_1452175674810&desc=[@string/gboard_ugc_desc_single]&appname=[@string/sp_smart_tips_text]&display_type=overlay
I/GBoardWebViewUtils( 2080): , category: com.lge.intent.category.gboard.DOYOUKNOW
I/GBoardWebViewUtils( 2080): , display: false
I/GBoardWebViewUtils( 2080): , animation: false }
D/WallpaperManager( 2080): suggestDesiredDimensions(2880, 2560) by package(com.lge.launcher2)
...
,I/art     ( 1040): Explicit concurrent mark sweep GC freed 15791(1101KB) AllocSpace objects, 5(464KB) LOS objects, 33% free, 44MB/67MB, paused 3.068ms total 253.207ms
I/[LGHome]EVENT( 2080): [LauncherModel.java:1141:onReceive()]onReceive intent=Intent { act=android.intent.action.PACKAGE_REMOVED dat=package:com.test.thalitest flg=0x4000010 (has extras) }
I/[LGHome]GBoardWebView( 2080): [GBoardWebView.java:321:loadCacheBitmap()]loadCacheBitmap()
V/SIM_STK ( 1040): Menu title from STK is T-Mobile
V/SIM_STK ( 1040): Menu title from STK is T-Mobile
...
D/LGBluetoothAvrcpQcomAdapter( 3816): [BTUI]          playState: 2 (PAUSED)
D/LGBluetoothAvrcpQcomAdapter( 3816): [BTUI] [-] updateMediaPlayerInfo
D/AppUp4:PreloadHelper( 7453): added Exclude : com.test.thalitest
I/ActivityManager( 1040): Start proc com.android.contacts for broadcast com.android.contacts/.quickcontact.PackageIntentReceiver: pid=7778 uid=10019 gids={50019, 9997, 3003, 1028, 1015, 1023, 4002} abi=armeabi-v7a
...
I/[LGHome]EVENT( 2080): [Launcher.java:5349:onStop()]onStop
...
I/ActivityManager( 1040): Killing 7018:com.lge.clock/u0a10 (adj 15): empty #17
...
I/[LGHome]Launcher.Model( 2080): [LauncherModel.java:2230:run()] LauncherModel bind current page shortcut
,I/[LGHome]Launcher( 2080): [Launcher.java:4127:setLoadOnResume()]setLoadOnResume
I/[LGHome]EVENT( 2080): [Workspace.java:918:addInScreen()]Add Shortcut [Email] in screen 1 [1, 4]
I/[LGHome]EVENT( 2080): [Workspace.java:918:addInScreen()]Add Shortcut [Play Store] in screen 1 [2, 4]
I/[LGHome]EVENT( 2080): [Workspace.java:918:addInScreen()]Add Shortcut [Camera] in screen 1 [3, 4]
I/[LGHome]EVENT( 2080): [Workspace.java:918:addInScreen()]Add Shortcut [Settings] in screen 1 [4, 4]
,D/AndroidRuntime( 7723): Shutting down VM
D/KeyguardModel( 1462): handleShortcutListChanged...
W/libprocessgroup( 1040): failed to open /acct/uid_10010/pid_7018/cgroup.procs: No such file or directory
I/Timeline( 1040): Timeline: Activity_windows_visible id: ActivityRecord{3c2294e8 u0 com.lge.launcher2/.Launcher t3} time:297440
I/[LGHome]NumberBadge.LGUnreadLgeEmailsBadge( 2080): [LGUnreadLgeEmailsBadge.java:107:countUnreadItems()]setTotalCount : 0
I/[LGHome]Launcher.Model( 2080): [LauncherModel.java:2244:run()] LauncherModel bind current page shortcut
I/[LGHome]NumberBadge.LGUnreadLgeEmailsBadge( 2080): [LGUnreadLgeEmailsBadge.java:108:countUnreadItems()]countUnreadItems() ended..
I/[LGHome]Launcher( 2080): [Launcher.java:4127:setLoadOnResume()]setLoadOnResume
...
I/[LGHome]EVENT( 2080): [Workspace.java:918:addInScreen()]Add Folder [Google] in screen 1 [0, 4]
,I/[LGHome]EVENT( 2080): [LauncherModel.java:1141:onReceive()]onReceive intent=Intent { act=android.search.action.SEARCHABLES_CHANGED flg=0x24000010 }
,I/[LGHome]Launcher.Model( 2080): [LauncherModel.java:2256:run()] LauncherModel bind current page widget
I/[LGHome]Launcher( 2080): [Launcher.java:4127:setLoadOnResume()]setLoadOnResume
I/[Concierge]WidgetView( 2080): ConciergeWidgetView is instantiated. sIsWidgetAttached : true
...
,D/[Concierge]WidgetView( 2080): change position of spinner
I/ActivityManager( 1040): Killing 7082:com.google.android.apps.books/u0a54 (adj 15): empty #17
W/libprocessgroup( 1040): failed to open /acct/uid_10054/pid_7082/cgroup.procs: No such file or directory
,I/[Concierge]WidgetView( 2080): initWebView(). Time : 1452511960173
...
D/VoicemailCleanupService( 2199): Cleaning up data for package: com.test.thalitest
I/PackageChangeReceiver( 7483): intent action : android.intent.action.PACKAGE_REMOVED (at PackageChangeReceiver.java onReceive 20)
I/ActivityManager( 1040): Start proc com.android.gallery3d for broadcast com.android.gallery3d/.app.PackagesMonitor: pid=7800 uid=10027 gids={50027, 9997, 3003, 1028, 1015, 1023, 4002, 4003} abi=armeabi-v7a
,I/[Concierge]WebView( 2080): Return exist ConciergeWebView. Reuse : 474611323
D/[Concierge]WidgetView( 2080): State Change : null -> AccInBeforeState
I/[LgeWidgetLib]LgeAppWidgetHostView( 2080): [LgeAppWidgetHostView.java:121:initExtManager()]mExtViewHost created
I/[LgeWidgetLib]ExtViewHost( 2080): [LgeAppWidgetExtViewHost.java:136:setState()]New State = com.lge.lgewidgetlib.extview.NormalState@1408d5a3
I/[LGHome]EVENT( 2080): [Workspace.java:918:addInScreen()]Add AppWidget [com.lge.concierge.ConciergeWidgetProvider] in screen 1 [0, 0]
I/[LGHome]Launcher.Model( 2080): [LauncherModel.java:2256:run()] LauncherModel bind current page widget
I/[LGHome]Launcher( 2080): [Launcher.java:4127:setLoadOnResume()]setLoadOnResume
,I/art     (  340): Explicit concurrent mark sweep GC freed 709(30KB) AllocSpace objects, 0(0B) LOS objects, 54% free, 26MB/58MB, paused 454us total 20.461ms
I/[LGHome]EVENT( 2080): [Workspace.java:918:addInScreen()]Add AppWidget [com.google.android.googlequicksearchbox.SearchWidgetProvider] in screen 1 [0, 2]
D/[Concierge]WidgetView( 2080): isWidgetUpdateSkippable ? true
D/[Concierge]WidgetBroadcastReceiver( 2080): New receiver registered. Self-unregister old one. ID : com.lge.concierge.ConciergeWidgetView.CommonReceiver
W/[Concierge]WidgetView( 2080): Widget kill message received. Destory myself. My : 1452511690707, New one : 1452511960173
D/[Concierge]WidgetView( 2080): Unregister all receivers
W/[Concierge]WidgetBroadcastReceiver( 2080): Tried unregister broadcastReceiver which is not registered. ID : com.lge.concierge.ConciergeWidgetView.CommonReceiver
,I/[LGHome]Launcher( 2080): [Launcher.java:4127:setLoadOnResume()]setLoadOnResume
I/[LGHome]EVENT( 2080): [Workspace.java:918:addInScreen()]Add Shortcut [Gallery] in screen 2 [0, 4]
I/[LGHome]EVENT( 2080): [Workspace.java:918:addInScreen()]Add Shortcut [Calendar] in screen 2 [1, 4]
I/[LGHome]EVENT( 2080): [Workspace.java:918:addInScreen()]Add Shortcut [QuickMemo+] in screen 2 [2, 4]
,I/art     (  340): Explicit concurrent mark sweep GC freed 5(160B) AllocSpace objects, 0(0B) LOS objects, 54% free, 26MB/58MB, paused 400us total 18.965ms
I/[LGHome]EVENT( 2080): [Workspace.java:918:addInScreen()]Add Shortcut [Quick Remote] in screen 2 [3, 4]
I/[LGHome]EVENT( 2080): [Workspace.java:918:addInScreen()]Add Shortcut [FM Radio] in screen 2 [4, 4]
I/[LGHome]Launcher( 2080): [Launcher.java:4127:setLoadOnResume()]setLoadOnResume
I/[LGHome]Launcher( 2080): [Launcher.java:4127:setLoadOnResume()]setLoadOnResume
I/art     (  340): Explicit concurrent mark sweep GC freed 5(160B) AllocSpace objects, 0(0B) LOS objects, 54% free, 26MB/58MB, paused 355us total 16.963ms
,W/ResourcesManager( 7800): Asset path '/system/framework/com.google.android.maps.jar' does not exist or contains no resources.
W/ResourcesManager( 7800): Asset path '/system/framework/com.google.android.media.effects.jar' does not exist or contains no resources.
,W/ResourcesManager( 7800): Asset path '/system/framework/com.lge.divx.jar' does not exist or contains no resources.
W/ResourcesManager( 7800): Asset path '/system/framework/com.lge.zdi.splitwindow.jar' does not exist or contains no resources.
I/[LgeWidgetLib]LgeAppWidgetHostView( 2080): [LgeAppWidgetHostView.java:121:initExtManager()]mExtViewHost created
,V/AlarmManager( 1040): ELAPSED_WAKEUP set : Alarm{2e2a62fa type 2 when 297702 com.google.android.gms} when 297702
E/[LgeWidgetLib]LgeAppWidgetHostView( 2080): [LgeAppWidgetHostView.java:124:initExtManager()]Cannot setExtViewHost, mExtViewHost --> null
I/[LGHome]EVENT( 2080): [Workspace.java:918:addInScreen()]Add AppWidget [com.lge.sizechangable.musicwidget.widget.MusicAppWidgetProvider4x1] in screen 2 [0, 0]
I/[LGHome]Launcher( 2080): [Launcher.java:4127:setLoadOnResume()]setLoadOnResume
,E/SharedPreferencesImpl( 2080): Couldn't rename file /data/user/0/com.lge.launcher2/shared_prefs/broadcast.numberbadge.counter.xml to backup file /data/user/0/com.lge.launcher2/shared_prefs/broadcast.numberbadge.counter.xml.bak
,I/Timeline( 2080): Timeline: Activity_idle id: android.os.BinderProxy@1730917a time:297744
I/AppConfig( 7800): Total System Memory = 2995761152
,D/SystemHelper( 7800): region [EU], country [EU], operator [OPEN], sub-operator []
E/SharedPreferencesImpl( 7800): Couldn't rename file /data/data/com.android.gallery3d/shared_prefs/com.android.gallery3d_preferences.xml to backup file /data/data/com.android.gallery3d/shared_prefs/com.android.gallery3d_preferences.xml.bak
